...
final class ca {
    ...
    public final /* synthetic */ Map j(List list) {
        ...
        for (bx next : this.f.values()) {
            ...
            if (list.contains(str)) {
                ...
                if ((bxVar == null ? -1 : bxVar.a) < next.a) {
    ...
    public final /* synthetic */ Boolean k(Bundle bundle) {
        ...
        if (bxVar.c.c == 6) {
            ...
            z = !ck.i(bxVar.c.c, bundle.getInt(i.e(NotificationCompat.CATEGORY_STATUS, t(bundle))));
        }
    ...
    public final /* synthetic */ Boolean l(Bundle bundle) {
        ...
        if (map.containsKey(valueOf)) {
            bx s = s(i);
            int i2 = bundle2.getInt(i.e(NotificationCompat.CATEGORY_STATUS, s.c.a));
            if (ck.i(s.c.c, i2)) {
                ...
                if (ck.g(i2)) {
                    ...
                    for (by next : s.c.e) {
                        ArrayList parcelableArrayList = bundle2.getParcelableArrayList(i.f("chunk_intents", s.c.a, next.a));
            ...
            int i5 = bundle2.getInt(i.e(NotificationCompat.CATEGORY_STATUS, t));
    ...
    public final /* synthetic */ void o(int i) {
        ...
        if (ck.g(s.c.c)) {
            au auVar = this.b;
            bw bwVar = s.c;
            auVar.B(bwVar.a, s.b, bwVar.b);
            bw bwVar2 = s.c;
            int i2 = bwVar2.c;
            if (i2 == 5 || i2 == 6) {
                this.b.C(bwVar2.a, s.b, bwVar2.b);
                return;
            }
            return;
        }
