...
public final class HttpLoggingInterceptor implements Interceptor {
    ...
    public final Level m1748deprecated_level() {
        return this.level;
    }
    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        if (connection != null) {
            str = MaskedEditText.SPACE + connection.protocol();
        } else {
            str = "";
        }
        sb.append(str);
        ...
        if (z2) {
            ...
            if (body != null) {
                ...
                if (contentType != null && headers.get(DefaultHttpClient.CONTENT_TYPE_KEY) == null) {
