    ...
    public InvalidationTracker(RoomDatabase roomDatabase, Map<String, String> map, Map<String, Set<String>> map2, String... strArr) {
        ...
        this.mRefreshRunnable = new Runnable() {
            /* JADX WARNING: Code restructure failed: missing block: B:32:0x008f, code lost:
                if (r5.this$0.mAutoCloser != null) goto L_0x0091;
             */
            ...
            /* JADX WARNING: Code restructure failed: missing block: B:40:0x00ac, code lost:
                if (r5.this$0.mAutoCloser == null) goto L_0x00af;
             */
            ...
            /* JADX WARNING: Code restructure failed: missing block: B:49:0x00c8, code lost:
                if (r2.hasNext() == false) goto L_0x00da;
             */
            ...
            public void run() {
                /*
                    ...
                    r0.lock()
                    r1 = 0
                    androidx.room.InvalidationTracker r2 = androidx.room.InvalidationTracker.this     // Catch:{ IllegalStateException -> 0x009d, SQLiteException -> 0x009b }
                    boolean r2 = r2.ensureInitialization()     // Catch:{ IllegalStateException -> 0x009d, SQLiteException -> 0x009b }
                ...
                L_0x0025:
                    androidx.room.InvalidationTracker r2 = androidx.room.InvalidationTracker.this     // Catch:{ IllegalStateException -> 0x009d, SQLiteException -> 0x009b }
                    java.util.concurrent.atomic.AtomicBoolean r2 = r2.mPendingRefresh     // Catch:{ IllegalStateException -> 0x009d, SQLiteException -> 0x009b }
                    r3 = 1
                    r4 = 0
                    boolean r2 = r2.compareAndSet(r3, r4)     // Catch:{ IllegalStateException -> 0x009d, SQLiteException -> 0x009b }
                ...
                L_0x0042:
                    androidx.room.InvalidationTracker r2 = androidx.room.InvalidationTracker.this     // Catch:{ IllegalStateException -> 0x009d, SQLiteException -> 0x009b }
                    androidx.room.RoomDatabase r2 = r2.mDatabase     // Catch:{ IllegalStateException -> 0x009d, SQLiteException -> 0x009b }
                    boolean r2 = r2.inTransaction()     // Catch:{ IllegalStateException -> 0x009d, SQLiteException -> 0x009b }
                ...
                L_0x005d:
                    androidx.room.InvalidationTracker r2 = androidx.room.InvalidationTracker.this     // Catch:{ IllegalStateException -> 0x009d, SQLiteException -> 0x009b }
                    androidx.room.RoomDatabase r2 = r2.mDatabase     // Catch:{ IllegalStateException -> 0x009d, SQLiteException -> 0x009b }
                    boolean r2 = r2.mWriteAheadLoggingEnabled     // Catch:{ IllegalStateException -> 0x009d, SQLiteException -> 0x009b }
                    if (r2 == 0) goto L_0x0084
                    androidx.room.InvalidationTracker r2 = androidx.room.InvalidationTracker.this     // Catch:{ IllegalStateException -> 0x009d, SQLiteException -> 0x009b }
                    androidx.room.RoomDatabase r2 = r2.mDatabase     // Catch:{ IllegalStateException -> 0x009d, SQLiteException -> 0x009b }
                    androidx.sqlite.db.SupportSQLiteOpenHelper r2 = r2.getOpenHelper()     // Catch:{ IllegalStateException -> 0x009d, SQLiteException -> 0x009b }
                    androidx.sqlite.db.SupportSQLiteDatabase r2 = r2.getWritableDatabase()     // Catch:{ IllegalStateException -> 0x009d, SQLiteException -> 0x009b }
                    r2.beginTransactionNonExclusive()     // Catch:{ IllegalStateException -> 0x009d, SQLiteException -> 0x009b }
                    java.util.Set r1 = r5.checkUpdatedTable()     // Catch:{ all -> 0x007f }
                    r2.setTransactionSuccessful()     // Catch:{ all -> 0x007f }
                    r2.endTransaction()     // Catch:{ IllegalStateException -> 0x009d, SQLiteException -> 0x009b }
                    goto L_0x0088
                L_0x007f:
                    r3 = move-exception
                    r2.endTransaction()     // Catch:{ IllegalStateException -> 0x009d, SQLiteException -> 0x009b }
                    throw r3     // Catch:{ IllegalStateException -> 0x009d, SQLiteException -> 0x009b }
                L_0x0084:
                    java.util.Set r1 = r5.checkUpdatedTable()     // Catch:{ IllegalStateException -> 0x009d, SQLiteException -> 0x009b }
                L_0x0088:
                    r0.unlock()
                    androidx.room.InvalidationTracker r0 = androidx.room.InvalidationTracker.this
                    androidx.room.AutoCloser r0 = r0.mAutoCloser
                ...
                L_0x00af:
                    ...
                    monitor-enter(r0)
                    androidx.room.InvalidationTracker r2 = androidx.room.InvalidationTracker.this     // Catch:{ all -> 0x00dc }
                    androidx.arch.core.internal.SafeIterableMap<androidx.room.InvalidationTracker$Observer, androidx.room.InvalidationTracker$ObserverWrapper> r2 = r2.mObserverMap     // Catch:{ all -> 0x00dc }
                ...
                L_0x00c4:
                    ...
                    java.util.Map$Entry r3 = (java.util.Map.Entry) r3     // Catch:{ all -> 0x00dc }
                    java.lang.Object r3 = r3.getValue()     // Catch:{ all -> 0x00dc }
                    androidx.room.InvalidationTracker$ObserverWrapper r3 = (androidx.room.InvalidationTracker.ObserverWrapper) r3     // Catch:{ all -> 0x00dc }
                    r3.notifyByTableInvalidStatus(r1)     // Catch:{ all -> 0x00dc }
                    goto L_0x00c4
                L_0x00da:
