...
public final class zzad extends SQLiteOpenHelper {
    public static final zzab zza = new zzab((DefaultConstructorMarker) null);
    ...
    public final int zza(List list) {
        ...
        return getWritableDatabase().delete("ce", "id IN ".concat(String.valueOf(CollectionsKt.joinToString$default(list, ", ", "(", ")", 0, (CharSequence) null, zzac.zza, 24, (Object) null))), (String[]) null);
    }
    ...
    public final java.util.List zzd() {
        ...
        L_0x0047:
            ...
            goto L_0x0051
        L_0x0049:
            java.util.List r1 = kotlin.collections.CollectionsKt.emptyList()     // Catch:{ all -> 0x0047 }
            r0.close()
            return r1
        L_0x0051:
            r0.close()
    ...
    public final boolean zzf(zzae zzae) {
        return zza(CollectionsKt.listOf(zzae)) == 1;
    }
}
