...
public class InviteFriend extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        return layoutInflater.inflate(R.layout.frag_navi_invitefriend, viewGroup, false);
    }
    ...
    private void initToolbar() {
        ...
        navigationDrawerItemsActivity.mToolbar_Title.setText(R.string.title_invitefriend);
