...
public final class CacheInterceptor implements Interceptor {
    ...
    private final Response cacheWritingResponse(CacheRequest cacheRequest, Response response) throws IOException {
        ...
        return response.newBuilder().body(new RealResponseBody(Response.header$default(response, DefaultHttpClient.CONTENT_TYPE_KEY, (String) null, 2, (Object) null), response.body().contentLength(), Okio.buffer((Source) cacheInterceptor$cacheWritingResponse$cacheWritingSource$1))).build();
    }
    ...
    public static final class Companion {
        ...
        private final boolean isContentSpecificHeader(String str) {
            if (StringsKt.equals("Content-Length", str, true) || StringsKt.equals("Content-Encoding", str, true) || StringsKt.equals(DefaultHttpClient.CONTENT_TYPE_KEY, str, true)) {
                return true;
            }
            return false;
        }
