...
public class DefaultHeartBeatController implements HeartBeatController, HeartBeatInfo {
    ...
    public Task<Void> registerHeartBeat() {
        ...
        return Tasks.call(this.backgroundExecutor, new Callable() {
            public final Object call() {
                return DefaultHeartBeatController.this.lambda$registerHeartBeat$0$DefaultHeartBeatController();
            }
        });
    }

    public /* synthetic */ Void lambda$registerHeartBeat$0$DefaultHeartBeatController() throws Exception {
        synchronized (this) {
    ...
    public Task<String> getHeartBeatsHeader() {
        ...
        return Tasks.call(this.backgroundExecutor, new Callable() {
            public final Object call() {
                return DefaultHeartBeatController.this.lambda$getHeartBeatsHeader$1$DefaultHeartBeatController();
            }
        });
    }

    public /* synthetic */ String lambda$getHeartBeatsHeader$1$DefaultHeartBeatController() throws Exception {
    ...
    private DefaultHeartBeatController(Context context, String str, Set<HeartBeatConsumer> set, Provider<UserAgentPublisher> provider, Executor executor) {
        this((Provider<HeartBeatInfoStorage>) new Provider(context, str) {
