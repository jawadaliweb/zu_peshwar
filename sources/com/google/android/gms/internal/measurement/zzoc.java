...
interface zzoc {
    ...
    void zzd(int i, zzka zzka) throws IOException;
    ...
    @Deprecated
    void zzq(int i, Object obj, zzmt zzmt) throws IOException;
    ...
    void zzv(int i, Object obj, zzmt zzmt) throws IOException;
