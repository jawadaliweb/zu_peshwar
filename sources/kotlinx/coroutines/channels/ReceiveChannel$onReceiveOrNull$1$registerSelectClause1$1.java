...
final class ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1 extends SuspendLambda implements Function2<ChannelResult<? extends E>, Continuation<? super R>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
        return m1577invokeWpGqRn0(((ChannelResult) obj).m1568unboximpl(), (Continuation) obj2);
    }

    /* renamed from: invoke-WpGqRn0  reason: not valid java name */
    public final Object m1577invokeWpGqRn0(Object obj, Continuation<? super R> continuation) {
        return ((ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1) create(ChannelResult.m1556boximpl(obj), continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Object r4 = ((ChannelResult) this.L$0).m1568unboximpl();
            Throwable r1 = ChannelResult.m1560exceptionOrNullimpl(r4);
            if (r1 == null) {
                Function2<E, Continuation<? super R>, Object> function2 = this.$block;
                Object r42 = ChannelResult.m1561getOrNullimpl(r4);
                this.label = 1;
