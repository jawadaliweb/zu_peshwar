...
public final class zzaq implements zzap {
    ...
    private static final void zzb(byte[] bArr) {
        for (zzkx zzkx : zzla.zzi(bArr).zzj()) {
            if (!CollectionsKt.listOf("INIT_TOTAL", "EXECUTE_TOTAL").contains(zzkx.zzj().name()) || !zzkx.zzS()) {
                zzkx.zzH();
                zzkx.zzI();
                zzkx.zzj().name();
                zzkx.zzT();
    ...
    public final boolean zza(byte[] bArr) {
        ...
        try {
            ...
            httpURLConnection.setRequestProperty(DefaultHttpClient.CONTENT_TYPE_KEY, "application/x-protobuffer");
