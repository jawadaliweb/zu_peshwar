...
final class CctTransportBackend implements TransportBackend {
    ...
    public HttpResponse doSend(HttpRequest httpRequest) throws IOException {
        ...
        try {
            ...
            try {
                ...
                Logging.d(LOG_TAG, "Content-Encoding: %s", (Object) httpURLConnection.getHeaderField(CONTENT_ENCODING_HEADER_KEY));
            ...
            return new HttpResponse(CacheLocation.INTERNAL_APP_DIR, (URL) null, 0);
        } catch (Throwable th4) {
    ...
    public BackendResponse send(BackendRequest backendRequest) {
        ...
        try {
            HttpResponse httpResponse = (HttpResponse) Retries.retry(5, new HttpRequest(url, requestBody, str), new Function() {
                public final Object apply(Object obj) {
                    return CctTransportBackend.this.doSend((CctTransportBackend.HttpRequest) obj);
                }
            }, $$Lambda$CctTransportBackend$Sr8nBLtE2gbjrB4Xb47yhMlbw.INSTANCE);
