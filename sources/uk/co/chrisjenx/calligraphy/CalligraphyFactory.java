...
class CalligraphyFactory {
    ...
    private void applyFontToToolbar(Toolbar toolbar) {
        ...
        toolbar.setTitle((CharSequence) MaskedEditText.SPACE);
        toolbar.setSubtitle((CharSequence) MaskedEditText.SPACE);
        int childCount = toolbar.getChildCount();
        for (int i = 0; i < childCount; i++) {
            onViewCreated(toolbar.getChildAt(i), toolbar.getContext(), (AttributeSet) null);
        }
