...
public final class Cache implements Closeable, Flushable {
    ...
    public final File m1625deprecated_directory() {
        return this.cache.getDirectory();
    }
    ...
    private static final class Entry {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:20:0x011b, code lost:
            r1 = move-exception;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:21:0x011c, code lost:
            kotlin.io.CloseableKt.closeFinally(r10, r0);
         */
        /* JADX WARNING: Code restructure failed: missing block: B:22:0x011f, code lost:
            throw r1;
         */
        ...
        public final void writeTo(okhttp3.internal.cache.DiskLruCache.Editor r10) throws java.io.IOException {
            /*
                ...
                r2 = r10
                okio.BufferedSink r2 = (okio.BufferedSink) r2     // Catch:{ all -> 0x0119 }
                java.lang.String r3 = r9.url     // Catch:{ all -> 0x0119 }
                okio.BufferedSink r3 = r2.writeUtf8(r3)     // Catch:{ all -> 0x0119 }
                r4 = 10
                r3.writeByte(r4)     // Catch:{ all -> 0x0119 }
                java.lang.String r3 = r9.requestMethod     // Catch:{ all -> 0x0119 }
                okio.BufferedSink r3 = r2.writeUtf8(r3)     // Catch:{ all -> 0x0119 }
                r3.writeByte(r4)     // Catch:{ all -> 0x0119 }
                okhttp3.Headers r3 = r9.varyHeaders     // Catch:{ all -> 0x0119 }
                int r3 = r3.size()     // Catch:{ all -> 0x0119 }
                long r5 = (long) r3     // Catch:{ all -> 0x0119 }
                okio.BufferedSink r3 = r2.writeDecimalLong(r5)     // Catch:{ all -> 0x0119 }
                r3.writeByte(r4)     // Catch:{ all -> 0x0119 }
                okhttp3.Headers r3 = r9.varyHeaders     // Catch:{ all -> 0x0119 }
                int r3 = r3.size()     // Catch:{ all -> 0x0119 }
                r5 = 0
            L_0x003f:
                ...
                okhttp3.Headers r7 = r9.varyHeaders     // Catch:{ all -> 0x0119 }
                java.lang.String r7 = r7.name(r5)     // Catch:{ all -> 0x0119 }
                okio.BufferedSink r7 = r2.writeUtf8(r7)     // Catch:{ all -> 0x0119 }
                okio.BufferedSink r6 = r7.writeUtf8(r6)     // Catch:{ all -> 0x0119 }
                okhttp3.Headers r7 = r9.varyHeaders     // Catch:{ all -> 0x0119 }
                java.lang.String r7 = r7.value(r5)     // Catch:{ all -> 0x0119 }
                okio.BufferedSink r6 = r6.writeUtf8(r7)     // Catch:{ all -> 0x0119 }
                r6.writeByte(r4)     // Catch:{ all -> 0x0119 }
                int r5 = r5 + 1
                goto L_0x003f
            L_0x0061:
                okhttp3.internal.http.StatusLine r3 = new okhttp3.internal.http.StatusLine     // Catch:{ all -> 0x0119 }
                okhttp3.Protocol r5 = r9.protocol     // Catch:{ all -> 0x0119 }
                int r7 = r9.code     // Catch:{ all -> 0x0119 }
                java.lang.String r8 = r9.message     // Catch:{ all -> 0x0119 }
                r3.<init>(r5, r7, r8)     // Catch:{ all -> 0x0119 }
                java.lang.String r3 = r3.toString()     // Catch:{ all -> 0x0119 }
                okio.BufferedSink r3 = r2.writeUtf8(r3)     // Catch:{ all -> 0x0119 }
                r3.writeByte(r4)     // Catch:{ all -> 0x0119 }
                okhttp3.Headers r3 = r9.responseHeaders     // Catch:{ all -> 0x0119 }
                int r3 = r3.size()     // Catch:{ all -> 0x0119 }
                int r3 = r3 + 2
                long r7 = (long) r3     // Catch:{ all -> 0x0119 }
                okio.BufferedSink r3 = r2.writeDecimalLong(r7)     // Catch:{ all -> 0x0119 }
                r3.writeByte(r4)     // Catch:{ all -> 0x0119 }
                okhttp3.Headers r3 = r9.responseHeaders     // Catch:{ all -> 0x0119 }
                int r3 = r3.size()     // Catch:{ all -> 0x0119 }
            L_0x008d:
                if (r0 >= r3) goto L_0x00ad
                okhttp3.Headers r5 = r9.responseHeaders     // Catch:{ all -> 0x0119 }
                java.lang.String r5 = r5.name(r0)     // Catch:{ all -> 0x0119 }
                okio.BufferedSink r5 = r2.writeUtf8(r5)     // Catch:{ all -> 0x0119 }
                okio.BufferedSink r5 = r5.writeUtf8(r6)     // Catch:{ all -> 0x0119 }
                okhttp3.Headers r7 = r9.responseHeaders     // Catch:{ all -> 0x0119 }
                java.lang.String r7 = r7.value(r0)     // Catch:{ all -> 0x0119 }
                okio.BufferedSink r5 = r5.writeUtf8(r7)     // Catch:{ all -> 0x0119 }
                r5.writeByte(r4)     // Catch:{ all -> 0x0119 }
                int r0 = r0 + 1
                goto L_0x008d
            L_0x00ad:
                java.lang.String r0 = SENT_MILLIS     // Catch:{ all -> 0x0119 }
                okio.BufferedSink r0 = r2.writeUtf8(r0)     // Catch:{ all -> 0x0119 }
                okio.BufferedSink r0 = r0.writeUtf8(r6)     // Catch:{ all -> 0x0119 }
                long r7 = r9.sentRequestMillis     // Catch:{ all -> 0x0119 }
                okio.BufferedSink r0 = r0.writeDecimalLong(r7)     // Catch:{ all -> 0x0119 }
                r0.writeByte(r4)     // Catch:{ all -> 0x0119 }
                java.lang.String r0 = RECEIVED_MILLIS     // Catch:{ all -> 0x0119 }
                okio.BufferedSink r0 = r2.writeUtf8(r0)     // Catch:{ all -> 0x0119 }
                okio.BufferedSink r0 = r0.writeUtf8(r6)     // Catch:{ all -> 0x0119 }
                long r5 = r9.receivedResponseMillis     // Catch:{ all -> 0x0119 }
                okio.BufferedSink r0 = r0.writeDecimalLong(r5)     // Catch:{ all -> 0x0119 }
                r0.writeByte(r4)     // Catch:{ all -> 0x0119 }
                boolean r0 = r9.isHttps()     // Catch:{ all -> 0x0119 }
                if (r0 == 0) goto L_0x0113
                r2.writeByte(r4)     // Catch:{ all -> 0x0119 }
                okhttp3.Handshake r0 = r9.handshake     // Catch:{ all -> 0x0119 }
                kotlin.jvm.internal.Intrinsics.checkNotNull(r0)     // Catch:{ all -> 0x0119 }
                okhttp3.CipherSuite r0 = r0.cipherSuite()     // Catch:{ all -> 0x0119 }
                java.lang.String r0 = r0.javaName()     // Catch:{ all -> 0x0119 }
                okio.BufferedSink r0 = r2.writeUtf8(r0)     // Catch:{ all -> 0x0119 }
                r0.writeByte(r4)     // Catch:{ all -> 0x0119 }
                okhttp3.Handshake r0 = r9.handshake     // Catch:{ all -> 0x0119 }
                java.util.List r0 = r0.peerCertificates()     // Catch:{ all -> 0x0119 }
                r9.writeCertList(r2, r0)     // Catch:{ all -> 0x0119 }
                okhttp3.Handshake r0 = r9.handshake     // Catch:{ all -> 0x0119 }
                java.util.List r0 = r0.localCertificates()     // Catch:{ all -> 0x0119 }
                r9.writeCertList(r2, r0)     // Catch:{ all -> 0x0119 }
                okhttp3.Handshake r0 = r9.handshake     // Catch:{ all -> 0x0119 }
                okhttp3.TlsVersion r0 = r0.tlsVersion()     // Catch:{ all -> 0x0119 }
                java.lang.String r0 = r0.javaName()     // Catch:{ all -> 0x0119 }
                okio.BufferedSink r0 = r2.writeUtf8(r0)     // Catch:{ all -> 0x0119 }
                r0.writeByte(r4)     // Catch:{ all -> 0x0119 }
            L_0x0113:
        ...
        public final Response response(DiskLruCache.Snapshot snapshot) {
            ...
            String str = this.responseHeaders.get(DefaultHttpClient.CONTENT_TYPE_KEY);
