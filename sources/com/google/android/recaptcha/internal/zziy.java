...
class zziy extends AbstractMap {
    ...
    /* synthetic */ zziy(int i, zzix zzix) {
        this.zza = i;
    }
    ...
    private final int zzk(Comparable comparable) {
        ...
        while (i <= size) {
            int i2 = (i + size) / 2;
            int compareTo2 = comparable.compareTo(((zzis) this.zzb.get(i2)).zza());
            if (compareTo2 < 0) {
                size = i2 - 1;
    ...
    public final Object zzl(int i) {
        zzn();
        Object value = ((zzis) this.zzb.remove(i)).getValue();
        if (!this.zzc.isEmpty()) {
    ...
    public final int hashCode() {
        ...
        for (int i2 = 0; i2 < zzb2; i2++) {
            i += ((zzis) this.zzb.get(i2)).hashCode();
        }
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int i2 = this.zza;
        if (size == i2) {
            zzis zzis = (zzis) this.zzb.remove(i2 - 1);
            zzm().put(zzis.zza(), zzis.getValue());
        }
        this.zzb.add(i, new zzis(this, comparable, obj));
        return null;
    }
