...
public final class UByteArrayKt {
    ...
    private static final byte[] m144ubyteArrayOfGBYM_sE(byte... bArr) {
    ...
    private static final byte[] UByteArray(int i, Function1<? super Integer, UByte> function1) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            bArr[i2] = function1.invoke(Integer.valueOf(i2)).m125unboximpl();
        }
        return UByteArray.m128constructorimpl(bArr);
    }
}
