...
public final class zzup implements zzbj {
    ...
    public zzup(ECPrivateKey eCPrivateKey, byte[] bArr, String str, int i, zzuo zzuo) throws GeneralSecurityException {
    ...
    public final byte[] zza(byte[] r10, byte[] r11) throws java.security.GeneralSecurityException {
        /*
            ...
            int r0 = r9.zzg
            int r11 = com.google.android.gms.internal.p001firebaseauthapi.zzut.zza(r11)
            int r0 = r0 + -1
        ...
        L_0x0049:
            ...
            throw r10
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p001firebaseauthapi.zzup.zza(byte[], byte[]):byte[]");
    }
}
