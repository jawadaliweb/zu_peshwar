...
public final class bg<T> {
    ...
    public final T a() {
        try {
            ...
            throw new bi(String.format("Failed to get value of field %s of type %s on object of type %s", new Object[]{this.b.getName(), this.a.getClass().getName(), this.c.getName()}), e);
        }
    }
    ...
    public final void b(T t) {
        try {
            ...
            throw new bi(String.format("Failed to set value of field %s of type %s on object of type %s", new Object[]{this.b.getName(), this.a.getClass().getName(), this.c.getName()}), e);
        }
    }
