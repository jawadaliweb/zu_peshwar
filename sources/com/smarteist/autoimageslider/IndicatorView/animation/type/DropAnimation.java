...
public class DropAnimation extends BaseAnimation<AnimatorSet> {
    ...
    public void onAnimatorUpdate(ValueAnimator valueAnimator, AnimationType animationType) {
        ...
        int i = AnonymousClass2.$SwitchMap$com$smarteist$autoimageslider$IndicatorView$animation$type$DropAnimation$AnimationType[animationType.ordinal()];
        if (i == 1) {
    ...
    /* renamed from: com.smarteist.autoimageslider.IndicatorView.animation.type.DropAnimation$2  reason: invalid class name */
    static /* synthetic */ class AnonymousClass2 {
        static final /* synthetic */ int[] $SwitchMap$com$smarteist$autoimageslider$IndicatorView$animation$type$DropAnimation$AnimationType;
        ...
        static {
            /*
                ...
                int r0 = r0.length
                int[] r0 = new int[r0]
                $SwitchMap$com$smarteist$autoimageslider$IndicatorView$animation$type$DropAnimation$AnimationType = r0
            ...
            L_0x0012:
                int[] r0 = $SwitchMap$com$smarteist$autoimageslider$IndicatorView$animation$type$DropAnimation$AnimationType     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = $SwitchMap$com$smarteist$autoimageslider$IndicatorView$animation$type$DropAnimation$AnimationType     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.smarteist.autoimageslider.IndicatorView.animation.type.DropAnimation.AnonymousClass2.<clinit>():void");
        }
    }
