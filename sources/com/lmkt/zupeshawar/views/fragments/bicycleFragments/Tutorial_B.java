...
public class Tutorial_B extends Fragment implements View.OnClickListener, IOnBackPressed {
    static int Title = 2131886362;
    Button Btn_Next;
    ...
    public void initViews(View view2) throws Exception {
        ...
        TranslateAnimation translateAnimation = new TranslateAnimation(-130.0f, -10.0f, 0.0f, 0.0f);
    ...
    public void onClick(View view2) {
        int id = view2.getId();
        if (id == R.id.Btn_Back) {
            this.activity.loadFragment(new Tutorial_A(), 0);
        } else if (id == R.id.Btn_Next) {
            this.activity.loadFragment(new Tutorial_C(), 1);
        }
    }
