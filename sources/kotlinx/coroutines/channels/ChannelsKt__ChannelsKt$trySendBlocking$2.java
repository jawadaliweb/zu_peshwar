    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            try {
                ...
                obj2 = Result.m58constructorimpl(ResultKt.createFailure(th));
            }
        } else {
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
        obj2 = Result.m58constructorimpl(Unit.INSTANCE);
        if (Result.m65isSuccessimpl(obj2)) {
            obj3 = ChannelResult.Companion.m1571successJP2dKIU(Unit.INSTANCE);
        } else {
            obj3 = ChannelResult.Companion.m1569closedJP2dKIU(Result.m61exceptionOrNullimpl(obj2));
        }
        return ChannelResult.m1556boximpl(obj3);
    }
}
