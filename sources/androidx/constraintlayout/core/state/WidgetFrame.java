...
public class WidgetFrame {
    ...
    public static void interpolate(int i, int i2, WidgetFrame widgetFrame, WidgetFrame widgetFrame2, WidgetFrame widgetFrame3, Transition transition, float f) {
        ...
        if (widgetFrame4.widget == null || !transition.hasPositionKeyframes()) {
            ...
            if (findNextPosition != null) {
                int i21 = (int) (findNextPosition.x * ((float) i8));
                int i22 = (int) (findNextPosition.y * ((float) i7));
        ...
        int i24 = (int) (((float) i23) + (((float) (i15 - i23)) * f5));
        widgetFrame4.left = i24;
        int i25 = (int) (((float) i14) + (f5 * ((float) (i16 - i14))));
        widgetFrame4.top = i25;
        float f11 = f;
        float f12 = 1.0f - f11;
        widgetFrame4.right = i24 + ((int) ((((float) i4) * f12) + (((float) i17) * f11)));
        widgetFrame4.bottom = i25 + ((int) ((f12 * ((float) i3)) + (((float) i19) * f11)));
    ...
    public void printCustomAttributes() {
        ...
        String str2 = (".(" + stackTraceElement.getFileName() + Constants.COMMON_SCHEMA_PREFIX_SEPARATOR + stackTraceElement.getLineNumber() + ") " + stackTraceElement.getMethodName()) + MaskedEditText.SPACE + (hashCode() % 1000);
        if (this.widget != null) {
            str = str2 + "/" + (this.widget.hashCode() % 1000) + MaskedEditText.SPACE;
        } else {
            str = str2 + "/NULL ";
        }
    ...
    public void logv(String str) {
        String str2;
        StackTraceElement stackTraceElement = new Throwable().getStackTrace()[1];
        String str3 = (".(" + stackTraceElement.getFileName() + Constants.COMMON_SCHEMA_PREFIX_SEPARATOR + stackTraceElement.getLineNumber() + ") " + stackTraceElement.getMethodName()) + MaskedEditText.SPACE + (hashCode() % 1000);
        if (this.widget != null) {
            str2 = str3 + "/" + (this.widget.hashCode() % 1000);
        } else {
            str2 = str3 + "/NULL";
        }
        System.out.println(str2 + MaskedEditText.SPACE + str);
    }
}
