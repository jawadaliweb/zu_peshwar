    ...
    static /* synthetic */ class AnonymousClass2 {
        ...
        static {
            /*
                ...
                int r0 = r0.length
                int[] r0 = new int[r0]
                $SwitchMap$com$smarteist$autoimageslider$IndicatorView$draw$data$RtlMode = r0
            ...
            L_0x0012:
                int[] r0 = $SwitchMap$com$smarteist$autoimageslider$IndicatorView$draw$data$RtlMode     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = $SwitchMap$com$smarteist$autoimageslider$IndicatorView$draw$data$RtlMode     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.smarteist.autoimageslider.IndicatorView.PageIndicatorView.AnonymousClass2.<clinit>():void");
        }
    }

    private boolean isRtl() {
        int i = AnonymousClass2.$SwitchMap$com$smarteist$autoimageslider$IndicatorView$draw$data$RtlMode[this.manager.indicator().getRtlMode().ordinal()];
        if (i == 1) {
            return true;
        }
