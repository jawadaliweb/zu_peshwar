...
public final class a {
    ...
    public static final int c(AssetManager assetManager, File file) {
        int intValue = ((Integer) bh.a(assetManager, "addAssetPath", Integer.class, String.class, file.getPath())).intValue();
    ...
    public final synchronized boolean a(android.content.Context r5, java.util.Set<java.lang.String> r6) {
        ...
        L_0x0022:
            ...
            com.google.android.play.core.splitcompat.c r3 = r4.a     // Catch:{ Exception -> 0x0045 }
            java.io.File r2 = r3.c(r2)     // Catch:{ Exception -> 0x0045 }
            r1.add(r2)     // Catch:{ Exception -> 0x0045 }
            goto L_0x0022
        L_0x0038:
            r4.b(r5, r1)     // Catch:{ Exception -> 0x0045 }
