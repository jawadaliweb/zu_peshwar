...
class UtcDates {
    ...
    private static String removeYearFromDateFormatPattern(String str) {
        ...
        return str.replace(str.substring(findCharactersInDateFormatPattern(str, str2, -1, findCharactersInDateFormatPattern) + 1, findCharactersInDateFormatPattern2), MaskedEditText.SPACE).trim();
    }
