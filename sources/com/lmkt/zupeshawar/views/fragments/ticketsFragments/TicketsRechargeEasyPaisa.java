...
public class TicketsRechargeEasyPaisa extends Fragment implements View.OnClickListener, IOnBackPressed, APIManager.Callback {
    static final /* synthetic */ boolean $assertionsDisabled = false;
    static String TAG = "Easy Paisa Fragment";
    EditText Amount_ET;
    Button Btn_Proceed;
    EditText Mobile_ET;
    EditText Name_ET;
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        return layoutInflater.inflate(R.layout.frag_tickets_recharge_easypaisa, viewGroup, false);
    }
    ...
    private void initToolbar() {
        ...
        this.activity.mToolbar_Title.setText(R.string.title_EPtopup);
    ...
    private boolean validate() {
        ...
        if (obj.isEmpty()) {
            ...
            this.topupDetails.setPaymentSource(1);
            return true;
        }
    }
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.Btn_Back) {
            ...
            try {
                this.topupDetails.setCNIC("");
                JSONObject createJsonRequest = createJsonRequest();
                this.activity.appAlerts.showEasyPaisaDialog(this.activity, true);
    ...
    public void onSuccess(int i, ApiResponse apiResponse) {
        ...
        if (i == ReturnCodes.Companion.OK()) {
            if (apiResponse.getRespCode().intValue() == ReturnCodes.Companion.BAD_REQUEST()) {
                this.activity.appAlerts.showAlertDialog(this.activity, apiResponse.getRespMessage(), "Server Message", new AppAlertDialog.AlertDialogListener() {
                    public final void onClicked() {
                        TicketsRechargeEasyPaisa.this.lambda$onSuccess$0$TicketsRechargeEasyPaisa();
                    }
                });
                ...
                this.activity.appAlerts.showSuccessDialog(this.activity, apiResponse.getRespMessage(), new AppAlertDialog.AlertDialogListener() {
                    public final void onClicked() {
                        TicketsRechargeEasyPaisa.this.lambda$onSuccess$1$TicketsRechargeEasyPaisa();
                    }
                });
            } else {
                this.activity.appAlerts.showSuccessDialog(this.activity, apiResponse.getRespMessage(), new AppAlertDialog.AlertDialogListener() {
                    public final void onClicked() {
                        TicketsRechargeEasyPaisa.this.lambda$onSuccess$2$TicketsRechargeEasyPaisa();
                    }
                });
            }
            ...
            this.activity.appAlerts.showAlertDialog(this.activity, apiResponse.getRespMessage(), "Server Message", new AppAlertDialog.AlertDialogListener() {
                public final void onClicked() {
                    TicketsRechargeEasyPaisa.this.lambda$onSuccess$3$TicketsRechargeEasyPaisa();
                }
            });
        } else {
            this.activity.appAlerts.showErrorDialog(this.activity, apiResponse.getRespMessage(), new AppAlertDialog.AlertDialogListener() {
                public final void onClicked() {
                    TicketsRechargeEasyPaisa.this.lambda$onSuccess$4$TicketsRechargeEasyPaisa();
                }
            });
        }
    }

    public /* synthetic */ void lambda$onSuccess$0$TicketsRechargeEasyPaisa() {
        this.activity.appAlerts.dismiss();
    }

    public /* synthetic */ void lambda$onSuccess$1$TicketsRechargeEasyPaisa() {
        this.activity.appAlerts.dismiss();
        this.activity.finish();
    }

    public /* synthetic */ void lambda$onSuccess$2$TicketsRechargeEasyPaisa() {
        this.activity.appAlerts.dismiss();
        this.activity.finish();
    }

    public /* synthetic */ void lambda$onSuccess$3$TicketsRechargeEasyPaisa() {
        this.activity.appAlerts.dismiss();
    }

    public /* synthetic */ void lambda$onSuccess$4$TicketsRechargeEasyPaisa() {
        this.activity.appAlerts.dismiss();
    }
    ...
    public void onFailure(int i, String str) {
        ...
        if (i == ReturnCodes.Companion.INVALID_DEVICE()) {
            ...
            appAlertDialog.showAlertDialog(ticketsMenuItemActivity, str + "\n Recharge between Rs.50 to Rs.5000", "Server Message", new AppAlertDialog.AlertDialogListener() {
                public final void onClicked() {
                    TicketsRechargeEasyPaisa.this.lambda$onFailure$5$TicketsRechargeEasyPaisa();
                }
            });
        } else {
            this.activity.appAlerts.showErrorDialog(this.activity, str, new AppAlertDialog.AlertDialogListener() {
                public final void onClicked() {
                    TicketsRechargeEasyPaisa.this.lambda$onFailure$6$TicketsRechargeEasyPaisa();
                }
            });
        }
    }

    public /* synthetic */ void lambda$onFailure$5$TicketsRechargeEasyPaisa() {
        this.activity.appAlerts.dismiss();
    }

    public /* synthetic */ void lambda$onFailure$6$TicketsRechargeEasyPaisa() {
        this.activity.appAlerts.dismiss();
    }
}
