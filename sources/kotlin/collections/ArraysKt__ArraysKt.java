...
class ArraysKt__ArraysKt extends ArraysKt__ArraysJVMKt {
                                                    ...
                                                    if (!(t instanceof UByteArray) || !(t2 instanceof UByteArray)) {
                                                        if (!(t instanceof UShortArray) || !(t2 instanceof UShortArray)) {
                                                            if (!(t instanceof UIntArray) || !(t2 instanceof UIntArray)) {
                                                                ...
                                                                } else if (!UArraysKt.m622contentEqualslec5QzE(((ULongArray) t).m298unboximpl(), ((ULongArray) t2).m298unboximpl())) {
                                                                    return false;
                                                                }
                                                            } else if (!UArraysKt.m618contentEqualsKJPZfPQ(((UIntArray) t).m220unboximpl(), ((UIntArray) t2).m220unboximpl())) {
                                                                return false;
                                                            }
                                                        } else if (!UArraysKt.m617contentEqualsFGO6Aew(((UShortArray) t).m402unboximpl(), ((UShortArray) t2).m402unboximpl())) {
                                                            return false;
                                                        }
                                                    } else if (!UArraysKt.m620contentEqualskV0jMPg(((UByteArray) t).m142unboximpl(), ((UByteArray) t2).m142unboximpl())) {
                                                        return false;
                                                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] r5, java.lang.StringBuilder r6, java.util.List<java.lang.Object[]> r7) {
        ...
        L_0x00c5:
            ...
            byte[] r4 = r2.m142unboximpl()
        L_0x00d2:
            java.lang.String r2 = kotlin.collections.unsigned.UArraysKt.m634contentToString2csIQuQ(r4)
            r6.append(r2)
            goto L_0x011d
        L_0x00da:
            ...
            short[] r4 = r2.m402unboximpl()
        L_0x00e6:
            java.lang.String r2 = kotlin.collections.unsigned.UArraysKt.m638contentToStringd6D3K8(r4)
            r6.append(r2)
            goto L_0x011d
        L_0x00ee:
            ...
            int[] r4 = r2.m220unboximpl()
        L_0x00fa:
            java.lang.String r2 = kotlin.collections.unsigned.UArraysKt.m637contentToStringXUkPCBk(r4)
            r6.append(r2)
            goto L_0x011d
        L_0x0102:
            ...
            long[] r4 = r2.m298unboximpl()
        L_0x010e:
            java.lang.String r2 = kotlin.collections.unsigned.UArraysKt.m640contentToStringuLth9ew(r4)
            r6.append(r2)
            goto L_0x011d
        L_0x0116:
