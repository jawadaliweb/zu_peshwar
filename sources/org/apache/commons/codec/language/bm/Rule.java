...
public class Rule {
    ...
    static {
        ...
        L_0x003d:
            ...
            java.util.Scanner r13 = createScanner(r4, r9, r12)     // Catch:{ IllegalStateException -> 0x0072 }
            ...
            r13.close()     // Catch:{ IllegalStateException -> 0x0072 }
            goto L_0x003d
        L_0x005e:
            r0 = move-exception
        ...
        L_0x0069:
            r2 = move-exception
            r0.addSuppressed(r2)     // Catch:{ IllegalStateException -> 0x0072 }
            goto L_0x0071
        L_0x006e:
            r13.close()     // Catch:{ IllegalStateException -> 0x0072 }
        L_0x0071:
            throw r1     // Catch:{ IllegalStateException -> 0x0072 }
        L_0x0072:
            r0 = move-exception
        ...
        L_0x008e:
            ...
            java.lang.String r13 = createResourceName(r4, r9, r11)     // Catch:{ all -> 0x00ad }
            java.util.Map r13 = parseRules(r12, r13)     // Catch:{ all -> 0x00ad }
            r10.put(r11, r13)     // Catch:{ all -> 0x00ad }
            ...
            if (!z) {
                if (nextLine.startsWith("/*")) {
                    ...
                    if (trim.length() == 0) {
                        ...
                        if (!trim2.contains(MaskedEditText.SPACE)) {
                        ...
                        if (split.length == 4) {
                            try {
                                ...
                                str2 = "' in ";
                                try {
                                    AnonymousClass2 r1 = new Rule(stripQuotes, stripQuotes2, stripQuotes3, parsePhonemeExpr(stripQuotes(split[3])), i3, str, stripQuotes, stripQuotes2, stripQuotes3) {
