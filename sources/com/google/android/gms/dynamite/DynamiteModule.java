...
public final class DynamiteModule {
    ...
    public static DynamiteModule load(Context context, VersionPolicy versionPolicy, String str) throws LoadingException {
        ...
        try {
            ...
            Log.i("DynamiteModule", "Considering local module " + str2 + Constants.COMMON_SCHEMA_PREFIX_SEPARATOR + i2 + " and remote module " + str2 + Constants.COMMON_SCHEMA_PREFIX_SEPARATOR + i3);
                                    ...
                                    if (bool.booleanValue()) {
                                        ...
                                        if (zzg2 != null) {
                                            ...
                                            if (zze2 >= 3) {
                                                ...
                                                if (zzn4 != null) {
                                                    iObjectWrapper = zzg2.zzi(ObjectWrapper.wrap(context), str2, i5, ObjectWrapper.wrap(zzn4.zza));
                                                } else {
                                                    throw new LoadingException("No cached result cursor holder", (zzp) null);
                                                }
                                            } else if (zze2 == 2) {
                                                Log.w("DynamiteModule", "IDynamite loader version = 2");
                                                iObjectWrapper = zzg2.zzj(ObjectWrapper.wrap(context), str2, i5);
                                            } else {
                                                Log.w("DynamiteModule", "Dynamite loader version < 2, falling back to createModuleContext");
                                                iObjectWrapper = zzg2.zzh(ObjectWrapper.wrap(context), str2, i5);
                                            }
