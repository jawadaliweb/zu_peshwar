...
public final class BridgeInterceptor implements Interceptor {
    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        if (body2 != null) {
            ...
            if (contentType != null) {
                newBuilder.header(DefaultHttpClient.CONTENT_TYPE_KEY, contentType.toString());
            }
        ...
        if (z && StringsKt.equals("gzip", Response.header$default(proceed, "Content-Encoding", (String) null, 2, (Object) null), true) && HttpHeaders.promisesBody(proceed) && (body = proceed.body()) != null) {
            ...
            request2.body(new RealResponseBody(Response.header$default(proceed, DefaultHttpClient.CONTENT_TYPE_KEY, (String) null, 2, (Object) null), -1, Okio.buffer((Source) gzipSource)));
        }
