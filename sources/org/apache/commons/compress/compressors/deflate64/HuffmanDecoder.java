...
class HuffmanDecoder implements Closeable {
    ...
    public static final int[] DISTANCE_TABLE = {16, 32, 48, 64, 81, 113, 146, 210, 275, TypedValues.Cycle.TYPE_ALPHA, 532, 788, 1045, 1557, 2070, 3094, 4119, 6167, 8216, 12312, 16409, 24601, 32794, 49178, 65563, 98331, 131100, 196636, 262173, 393245, 524318, 786462};
    ...
    public final InputStream f23in;
    /* access modifiers changed from: private */
        ...
        public int read(byte[] bArr, int i, int i2) throws IOException {
            ...
            while (i4 < min) {
                if (HuffmanDecoder.this.reader.bitsCached() > 0) {
                    ...
                    int i5 = i + i4;
                    i3 = HuffmanDecoder.this.f23in.read(bArr, i5, min - i4);
                    if (i3 != -1) {
