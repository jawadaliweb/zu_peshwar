...
class GmsRpc {
    ...
    private Task<String> extractResponseWhenComplete(Task<Bundle> task) {
        return task.continueWith($$Lambda$PNiE7SuEFxRjAZH7pJpZIFOFjWg.INSTANCE, new Continuation() {
    ...
    public /* synthetic */ String lambda$extractResponseWhenComplete$0$GmsRpc(Task task) throws Exception {
