...
public final class ThreadPoolDispatcherKt {
        ...
        if (z) {
            return ExecutorsKt.from((ExecutorService) Executors.newScheduledThreadPool(i, new ThreadFactory(i, str, new AtomicInteger()) {
                ...
                public final Thread newThread(Runnable runnable) {
                    return ThreadPoolDispatcherKt.m1538newFixedThreadPoolContext$lambda1(this.f$0, this.f$1, this.f$2, runnable);
                }
            }));
        }
    ...
    public static final Thread m1538newFixedThreadPoolContext$lambda1(int i, String str, AtomicInteger atomicInteger, Runnable runnable) {
        if (i != 1) {
