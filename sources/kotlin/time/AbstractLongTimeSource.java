...
public abstract class AbstractLongTimeSource implements TimeSource {
    ...
    private static final class LongTimeMark implements TimeMark {
        ...
        public TimeMark m1361minusLRDsOJo(long j) {
            return TimeMark.DefaultImpls.m1509minusLRDsOJo(this, j);
        }

        /* renamed from: elapsedNow-UwyO8pc  reason: not valid java name */
        public long m1360elapsedNowUwyO8pc() {
        ...
        public TimeMark m1362plusLRDsOJo(long j) {
            return new LongTimeMark(this.startedAt, this.timeSource, Duration.m1407plusLRDsOJo(this.offset, j), (DefaultConstructorMarker) null);
        }
    }

    public TimeMark markNow() {
        return new LongTimeMark(read(), this, Duration.Companion.m1473getZEROUwyO8pc(), (DefaultConstructorMarker) null);
    }
}
