...
public class ConfigFetchHandler {
    ...
    public Task<FetchResponse> fetch(long j) {
        ...
        return this.fetchedConfigsCache.get().continueWithTask(this.executor, new Continuation(j, hashMap) {
            ...
            public final Object then(Task task) {
                return ConfigFetchHandler.this.lambda$fetch$0$ConfigFetchHandler(this.f$1, this.f$2, task);
            }
        });
    }
    ...
    public Task<FetchResponse> fetchNowWithTypeAndAttemptNumber(FetchType fetchType, int i) {
        ...
        return this.fetchedConfigsCache.get().continueWithTask(this.executor, new Continuation(hashMap) {
            ...
            public final Object then(Task task) {
                return ConfigFetchHandler.this.lambda$fetchNowWithTypeAndAttemptNumber$1$ConfigFetchHandler(this.f$1, task);
            }
        });
    }

    public /* synthetic */ Task lambda$fetchNowWithTypeAndAttemptNumber$1$ConfigFetchHandler(Map map, Task task) throws Exception {
        return lambda$fetch$0$ConfigFetchHandler(task, 0, map);
    }

    /* access modifiers changed from: private */
    /* renamed from: fetchIfCacheExpiredAndNotThrottled */
    public Task<FetchResponse> lambda$fetch$0$ConfigFetchHandler(Task<ConfigContainer> task, long j, Map<String, String> map) {
        ...
        if (backoffEndTimeInMillis != null) {
            ...
            task2 = Tasks.whenAllComplete((Task<?>[]) new Task[]{id, token}).continueWithTask(this.executor, new Continuation(id, token, date, map) {
                ...
                public final Object then(Task task) {
                    return ConfigFetchHandler.this.lambda$fetchIfCacheExpiredAndNotThrottled$2$ConfigFetchHandler(this.f$1, this.f$2, this.f$3, this.f$4, task);
                }
            });
        }
        return task2.continueWithTask(this.executor, new Continuation(date) {
            ...
            public final Object then(Task task) {
                return ConfigFetchHandler.this.lambda$fetchIfCacheExpiredAndNotThrottled$3$ConfigFetchHandler(this.f$1, task);
            }
        });
    }

    public /* synthetic */ Task lambda$fetchIfCacheExpiredAndNotThrottled$2$ConfigFetchHandler(Task task, Task task2, Date date, Map map, Task task3) throws Exception {
    ...
    public /* synthetic */ Task lambda$fetchIfCacheExpiredAndNotThrottled$3$ConfigFetchHandler(Date date, Task task) throws Exception {
    ...
    private Task<FetchResponse> fetchFromBackendAndCacheResponse(String str, String str2, Date date, Map<String, String> map) {
        try {
            ...
            return this.fetchedConfigsCache.put(fetchFromBackend.getFetchedConfigs()).onSuccessTask(this.executor, new SuccessContinuation() {
