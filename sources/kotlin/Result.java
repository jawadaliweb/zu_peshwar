...
public final class Result<T> implements Serializable {
    ...
    public static <T> Object m58constructorimpl(Object obj) {
        return obj;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m59equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof Result) && Intrinsics.areEqual(obj, ((Result) obj2).m67unboximpl());
    }
    ...
    public static final class Companion {
        ...
        private final <T> Object success(T t) {
            return Result.m58constructorimpl(t);
        }

        private final <T> Object failure(Throwable th) {
            Intrinsics.checkNotNullParameter(th, "exception");
            return Result.m58constructorimpl(ResultKt.createFailure(th));
        }
    }
