...
public class SliderView extends FrameLayout implements Runnable, View.OnTouchListener, SliderViewAdapter.DataSetListener, SliderPager.OnPageChangeListener {
    ...
    private void setUpAttributes(Context context, AttributeSet attributeSet) {
        ...
        if (this.mIsIndicatorEnabled) {
            initIndicator();
            if (obtainStyledAttributes.getInt(R.styleable.SliderView_sliderIndicatorOrientation, Orientation.HORIZONTAL.ordinal()) == 0) {
                orientation = Orientation.HORIZONTAL;
            } else {
                orientation = Orientation.VERTICAL;
            }
            int dimension = (int) obtainStyledAttributes.getDimension(R.styleable.SliderView_sliderIndicatorMarginLeft, (float) DensityUtils.dpToPx(12));
            int dimension2 = (int) obtainStyledAttributes.getDimension(R.styleable.SliderView_sliderIndicatorMarginTop, (float) DensityUtils.dpToPx(12));
            int dimension3 = (int) obtainStyledAttributes.getDimension(R.styleable.SliderView_sliderIndicatorMarginRight, (float) DensityUtils.dpToPx(12));
            int dimension4 = (int) obtainStyledAttributes.getDimension(R.styleable.SliderView_sliderIndicatorMarginBottom, (float) DensityUtils.dpToPx(12));
            ...
            setIndicatorRadius((int) obtainStyledAttributes.getDimension(R.styleable.SliderView_sliderIndicatorRadius, (float) DensityUtils.dpToPx(2)));
            setIndicatorPadding((int) obtainStyledAttributes.getDimension(R.styleable.SliderView_sliderIndicatorPadding, (float) DensityUtils.dpToPx(3)));
            setIndicatorMargin((int) obtainStyledAttributes.getDimension(R.styleable.SliderView_sliderIndicatorMargin, (float) DensityUtils.dpToPx(12)));
    ...
    static /* synthetic */ class AnonymousClass2 {
        ...
        static {
            ...
            L_0x00fc:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.smarteist.autoimageslider.SliderView.AnonymousClass2.<clinit>():void");
        }
    }

    public void setSliderTransformAnimation(SliderAnimations sliderAnimations) {
        switch (AnonymousClass2.$SwitchMap$com$smarteist$autoimageslider$SliderAnimations[sliderAnimations.ordinal()]) {
            case 1:
