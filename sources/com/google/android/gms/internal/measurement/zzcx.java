...
final class zzcx extends zzdu {
    ...
    public final void zza() {
        ...
        try {
            ...
            ((zzcc) Preconditions.checkNotNull(this.zze.zzj)).initialize(ObjectWrapper.wrap(this.zzc), new zzcl(77000, (long) Math.max(localVersion, remoteVersion), remoteVersion < localVersion, str3, str2, str, this.zzd, zzfw.zza(this.zzc)), this.zzh);
        } catch (Exception e) {
