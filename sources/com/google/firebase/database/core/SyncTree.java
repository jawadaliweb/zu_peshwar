...
public class SyncTree {
    ...
    public Node getServerValue(QuerySpec querySpec) {
        return (Node) this.persistenceManager.runInTransaction(new Callable(querySpec) {
            ...
            public final Object call() {
                return SyncTree.this.lambda$getServerValue$0$SyncTree(this.f$1);
            }
        });
    }
    ...
    public /* synthetic */ Node lambda$getServerValue$0$SyncTree(QuerySpec querySpec) throws Exception {
        ...
        return syncPoint.getView(querySpec, this.pendingWriteTree.childWrites(path), new CacheNode(from, z, false)).getCompleteNode();
    }
    ...
    public List<Event> removeEventRegistration(EventRegistration eventRegistration, boolean z) {
        return removeEventRegistration(eventRegistration.getQuerySpec(), eventRegistration, (DatabaseError) null, z);
    }
    ...
    private List<Event> removeEventRegistration(QuerySpec querySpec, EventRegistration eventRegistration, DatabaseError databaseError, boolean z) {
        ...
        return (List) this.persistenceManager.runInTransaction(new Callable<List<Event>>() {
            public List<Event> call() {
                ...
                if (syncPoint != null && (querySpec2.isDefault() || syncPoint.viewExistsForQuery(querySpec2))) {
                    ...
                    ImmutableTree access$600 = SyncTree.this.syncPointTree;
                    boolean z2 = access$600.getValue() != null && ((SyncPoint) access$600.getValue()).hasCompleteView();
                    Iterator<ChildKey> it2 = path.iterator();
                    while (it2.hasNext()) {
                        access$600 = access$600.getChild(it2.next());
                        z2 = z2 || (access$600.getValue() != null && ((SyncPoint) access$600.getValue()).hasCompleteView());
                        if (!z2) {
                    ...
                    if (!z2 && !first.isEmpty() && databaseError2 == null) {
                        if (z) {
