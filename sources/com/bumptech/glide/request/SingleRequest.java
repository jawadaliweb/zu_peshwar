...
public final class SingleRequest<R> implements Request, SizeReadyCallback, ResourceCallback {
    ...
    public void onResourceReady(com.bumptech.glide.load.engine.Resource<?> r6, com.bumptech.glide.load.DataSource r7, boolean r8) {
        /*
            ...
            java.lang.Class<R> r8 = r5.transcodeClass     // Catch:{ all -> 0x00b6 }
            r7.append(r8)     // Catch:{ all -> 0x00b6 }
        ...
        L_0x0056:
            return
        L_0x0057:
            r5.onResourceReady(r6, r2, r7, r8)     // Catch:{ all -> 0x00b6 }
            monitor-exit(r1)     // Catch:{ all -> 0x00b6 }
            return
        L_0x005c:
            r5.resource = r0     // Catch:{ all -> 0x00b2 }
            ...
            java.lang.Class<R> r0 = r5.transcodeClass     // Catch:{ all -> 0x00b2 }
            r8.append(r0)     // Catch:{ all -> 0x00b2 }
