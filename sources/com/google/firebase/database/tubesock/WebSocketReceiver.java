...
class WebSocketReceiver {
            ...
            try {
                ...
                if (!((bArr[0] & 112) != 0)) {
                    ...
                    if (b2 < 126) {
                        ...
                        j = (((long) (bArr3[2] & UByte.MAX_VALUE)) << 8) | ((long) (bArr3[3] & UByte.MAX_VALUE));
    ...
    private long parseLong(byte[] bArr, int i) {
        return (((long) bArr[i + 0]) << 56) + (((long) (bArr[i + 1] & UByte.MAX_VALUE)) << 48) + (((long) (bArr[i + 2] & UByte.MAX_VALUE)) << 40) + (((long) (bArr[i + 3] & UByte.MAX_VALUE)) << 32) + (((long) (bArr[i + 4] & UByte.MAX_VALUE)) << 24) + ((long) ((bArr[i + 5] & UByte.MAX_VALUE) << 16)) + ((long) ((bArr[i + 6] & UByte.MAX_VALUE) << 8)) + ((long) ((bArr[i + 7] & UByte.MAX_VALUE) << 0));
    }
