...
public final class CoroutineScheduler implements Executor, Closeable {
    ...
    private final int createdWorkers(long j) {
        return (int) (j & TarConstants.MAXID);
    }
    ...
    private final boolean tryCreateWorker(long j) {
        if (RangesKt.coerceAtLeast(((int) (TarConstants.MAXID & j)) - ((int) ((j & BLOCKING_MASK) >> 21)), 0) < this.corePoolSize) {
                ...
                if (!coroutineScheduler.isTerminated()) {
                    if (((int) (coroutineScheduler.controlState & TarConstants.MAXID)) > coroutineScheduler.corePoolSize) {
                        if (workerCtl$FU.compareAndSet(this, -1, 1)) {
                            ...
                            int andDecrement = (int) (CoroutineScheduler.controlState$FU.getAndDecrement(coroutineScheduler) & TarConstants.MAXID);
                            if (andDecrement != i) {
