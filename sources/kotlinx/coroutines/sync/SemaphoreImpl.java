...
final class SemaphoreImpl implements Semaphore {
    ...
    public final boolean addAcquireToQueue(CancellableContinuation<? super Unit> cancellableContinuation) {
        ...
        do {
            ...
            while (true) {
                if (segment.getId() >= access$getSEGMENT_SIZE$p && !segment.getRemoved()) {
                    obj = SegmentOrClosed.m1602constructorimpl(segment);
                    break;
                }
                Object access$getNextOrClosed = segment.getNextOrClosed();
                if (access$getNextOrClosed == ConcurrentLinkedListKt.CLOSED) {
                    obj = SegmentOrClosed.m1602constructorimpl(ConcurrentLinkedListKt.CLOSED);
                    break;
                }
            ...
            z = true;
            if (SegmentOrClosed.m1607isClosedimpl(obj)) {
                break;
            }
            Segment r8 = SegmentOrClosed.m1605getSegmentimpl(obj);
            while (true) {
        ...
        SemaphoreSegment semaphoreSegment2 = (SemaphoreSegment) SegmentOrClosed.m1605getSegmentimpl(obj);
    ...
    private final boolean tryResumeNextFromQueue() {
        ...
        L_0x0014:
            ...
            goto L_0x0028
        L_0x0023:
            java.lang.Object r5 = kotlinx.coroutines.internal.SegmentOrClosed.m1602constructorimpl(r5)
            goto L_0x003d
        L_0x0028:
            r6 = r5
            ...
            java.lang.Object r5 = kotlinx.coroutines.internal.SegmentOrClosed.m1602constructorimpl(r5)
        L_0x003d:
            boolean r6 = kotlinx.coroutines.internal.SegmentOrClosed.m1607isClosedimpl(r5)
            r7 = 0
            r8 = 1
            if (r6 != 0) goto L_0x0082
            kotlinx.coroutines.internal.Segment r6 = kotlinx.coroutines.internal.SegmentOrClosed.m1605getSegmentimpl(r5)
        L_0x0049:
        ...
        L_0x0078:
            ...
            goto L_0x0049
        L_0x0082:
            kotlinx.coroutines.internal.Segment r0 = kotlinx.coroutines.internal.SegmentOrClosed.m1605getSegmentimpl(r5)
            kotlinx.coroutines.sync.SemaphoreSegment r0 = (kotlinx.coroutines.sync.SemaphoreSegment) r0
            r0.cleanPrev()
            long r5 = r0.getId()
