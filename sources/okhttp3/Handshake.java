...
public final class Handshake {
    ...
    public final TlsVersion m1660deprecated_tlsVersion() {
        return this.tlsVersion;
    }
    ...
    public final CipherSuite m1655deprecated_cipherSuite() {
        return this.cipherSuite;
    }
    ...
    public final List<Certificate> m1658deprecated_peerCertificates() {
    ...
    public final Principal m1659deprecated_peerPrincipal() {
    ...
    public final List<Certificate> m1656deprecated_localCertificates() {
        return this.localCertificates;
    }
    ...
    public final Principal m1657deprecated_localPrincipal() {
    ...
    private final String getName(Certificate certificate) {
        ...
        Intrinsics.checkNotNullExpressionValue(type, CommonProperties.TYPE);
        return type;
    }
    ...
    public static final class Companion {
        ...
        public final Handshake m1661deprecated_get(SSLSession sSLSession) throws IOException {
