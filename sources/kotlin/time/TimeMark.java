...
public interface TimeMark {
    ...
    TimeMark m1507minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    TimeMark m1508plusLRDsOJo(long j);

    @Metadata(k = 3, mv = {1, 7, 1}, xi = 48)
    /* compiled from: TimeSource.kt */
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo  reason: not valid java name */
        public static TimeMark m1510plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, (DefaultConstructorMarker) null);
        }

        /* renamed from: minus-LRDsOJo  reason: not valid java name */
        public static TimeMark m1509minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.m1508plusLRDsOJo(Duration.m1423unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m1404isNegativeimpl(timeMark.m1506elapsedNowUwyO8pc());
        }
