...
class FilesKt__FileReadWriteKt extends FilesKt__FilePathComponentsKt {
    ...
    public static final byte[] readBytes(java.io.File r11) {
        /*
            ...
            r1 = r0
            java.io.FileInputStream r1 = (java.io.FileInputStream) r1     // Catch:{ all -> 0x00af }
            long r2 = r11.length()     // Catch:{ all -> 0x00af }
            r4 = 2147483647(0x7fffffff, double:1.060997895E-314)
            java.lang.String r6 = "File "
            int r7 = (r2 > r4 ? 1 : (r2 == r4 ? 0 : -1))
            if (r7 > 0) goto L_0x008d
            int r3 = (int) r2
            byte[] r2 = new byte[r3]     // Catch:{ all -> 0x00af }
            r4 = 0
            r5 = r3
            r7 = 0
        L_0x0022:
            if (r5 <= 0) goto L_0x002d
            int r8 = r1.read(r2, r7, r5)     // Catch:{ all -> 0x00af }
        ...
        L_0x002d:
            ...
            byte[] r2 = java.util.Arrays.copyOf(r2, r7)     // Catch:{ all -> 0x00af }
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r2, r8)     // Catch:{ all -> 0x00af }
            goto L_0x006f
        L_0x003a:
            int r5 = r1.read()     // Catch:{ all -> 0x00af }
            r7 = -1
            if (r5 != r7) goto L_0x0042
            goto L_0x006f
        L_0x0042:
            kotlin.io.ExposingBufferByteArrayOutputStream r7 = new kotlin.io.ExposingBufferByteArrayOutputStream     // Catch:{ all -> 0x00af }
            r10 = 8193(0x2001, float:1.1481E-41)
            r7.<init>(r10)     // Catch:{ all -> 0x00af }
            r7.write(r5)     // Catch:{ all -> 0x00af }
            java.io.InputStream r1 = (java.io.InputStream) r1     // Catch:{ all -> 0x00af }
            r5 = r7
            java.io.OutputStream r5 = (java.io.OutputStream) r5     // Catch:{ all -> 0x00af }
            r10 = 2
            kotlin.io.ByteStreamsKt.copyTo$default(r1, r5, r4, r10, r9)     // Catch:{ all -> 0x00af }
            int r1 = r7.size()     // Catch:{ all -> 0x00af }
            int r1 = r1 + r3
            if (r1 < 0) goto L_0x0073
            byte[] r11 = r7.getBuffer()     // Catch:{ all -> 0x00af }
            byte[] r1 = java.util.Arrays.copyOf(r2, r1)     // Catch:{ all -> 0x00af }
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r1, r8)     // Catch:{ all -> 0x00af }
            int r2 = r7.size()     // Catch:{ all -> 0x00af }
            byte[] r2 = kotlin.collections.ArraysKt.copyInto((byte[]) r11, (byte[]) r1, (int) r3, (int) r4, (int) r2)     // Catch:{ all -> 0x00af }
        L_0x006f:
            kotlin.io.CloseableKt.closeFinally(r0, r9)
            return r2
        L_0x0073:
            java.lang.OutOfMemoryError r1 = new java.lang.OutOfMemoryError     // Catch:{ all -> 0x00af }
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ all -> 0x00af }
            r2.<init>()     // Catch:{ all -> 0x00af }
            r2.append(r6)     // Catch:{ all -> 0x00af }
            r2.append(r11)     // Catch:{ all -> 0x00af }
            java.lang.String r11 = " is too big to fit in memory."
            r2.append(r11)     // Catch:{ all -> 0x00af }
            java.lang.String r11 = r2.toString()     // Catch:{ all -> 0x00af }
    ...
    public static /* synthetic */ java.lang.Object useLines$default(java.io.File r2, java.nio.charset.Charset r3, kotlin.jvm.functions.Function1 r4, int r5, java.lang.Object r6) {
        ...
        L_0x0023:
            ...
            r2 = 0
            r3 = r0
            java.io.BufferedReader r3 = (java.io.BufferedReader) r3     // Catch:{ all -> 0x003b }
            kotlin.sequences.Sequence r3 = kotlin.io.TextStreamsKt.lineSequence(r3)     // Catch:{ all -> 0x003b }
            java.lang.Object r3 = r4.invoke(r3)     // Catch:{ all -> 0x003b }
