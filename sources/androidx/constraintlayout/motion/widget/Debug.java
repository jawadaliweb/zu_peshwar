...
public class Debug {
    public static void logStack(String str, String str2, int i) {
        ...
        for (int i2 = 1; i2 <= min; i2++) {
            ...
            str3 = str3 + MaskedEditText.SPACE;
            Log.v(str, str2 + str3 + (".(" + stackTrace[i2].getFileName() + Constants.COMMON_SCHEMA_PREFIX_SEPARATOR + stackTrace[i2].getLineNumber() + ") " + stackTrace[i2].getMethodName()) + str3);
        }
    }
    ...
    public static void printStack(String str, int i) {
        ...
        for (int i2 = 1; i2 <= min; i2++) {
            ...
            printStream.println(str + str2 + (".(" + stackTrace[i2].getFileName() + Constants.COMMON_SCHEMA_PREFIX_SEPARATOR + stackTrace[i2].getLineNumber() + ") ") + str2);
        }
    }
    ...
    public static void dumpPoc(Object obj) {
        ...
        String str = ".(" + stackTraceElement.getFileName() + Constants.COMMON_SCHEMA_PREFIX_SEPARATOR + stackTraceElement.getLineNumber() + ")";
                        ...
                        if (!(obj2 instanceof Integer) || !obj2.toString().equals("0")) {
                            if (!(obj2 instanceof Float) || !obj2.toString().equals("1.0")) {
                                if (!(obj2 instanceof Float) || !obj2.toString().equals("0.5")) {
                                    System.out.println(str + "    " + field.getName() + MaskedEditText.SPACE + obj2);
                                }
                            }
                        }
                    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:14:?, code lost:
        r0 = "? " + r6[r1] + br.com.sapereaude.maskedEditText.MaskedEditText.SPACE;
     */
    ...
    public static String getLocation() {
        StackTraceElement stackTraceElement = new Throwable().getStackTrace()[1];
        return ".(" + stackTraceElement.getFileName() + Constants.COMMON_SCHEMA_PREFIX_SEPARATOR + stackTraceElement.getLineNumber() + ")";
    }

    public static String getLoc() {
        StackTraceElement stackTraceElement = new Throwable().getStackTrace()[1];
        return ".(" + stackTraceElement.getFileName() + Constants.COMMON_SCHEMA_PREFIX_SEPARATOR + stackTraceElement.getLineNumber() + ") " + stackTraceElement.getMethodName() + "()";
    }
    ...
    public static void dumpLayoutParams(ViewGroup viewGroup, String str) {
        StackTraceElement stackTraceElement = new Throwable().getStackTrace()[1];
        String str2 = ".(" + stackTraceElement.getFileName() + Constants.COMMON_SCHEMA_PREFIX_SEPARATOR + stackTraceElement.getLineNumber() + ") " + str + "  ";
                ...
                try {
                    ...
                    if (field.getName().contains("To")) {
                        if (!obj.toString().equals("-1")) {
                            System.out.println(str2 + "       " + field.getName() + MaskedEditText.SPACE + obj);
                        }
                    }
                } catch (IllegalAccessException unused) {
                }
    ...
    public static void dumpLayoutParams(ViewGroup.LayoutParams layoutParams, String str) {
        ...
        for (Field field : fields) {
            try {
                ...
                if (name.contains("To")) {
                    if (!obj.toString().equals("-1")) {
                        System.out.println(str2 + "       " + name + MaskedEditText.SPACE + obj);
                    }
                }
            } catch (IllegalAccessException unused) {
            }
