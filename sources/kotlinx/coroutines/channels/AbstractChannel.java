...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    public final java.lang.Object m1545receiveCatchingJP2dKIU(kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r5) {
        /*
            r4 = this;
        ...
        L_0x0032:
            ...
            java.lang.Object r5 = r0.m1569closedJP2dKIU(r5)
            goto L_0x0052
        L_0x004c:
            kotlinx.coroutines.channels.ChannelResult$Companion r0 = kotlinx.coroutines.channels.ChannelResult.Companion
            java.lang.Object r5 = r0.m1571successJP2dKIU(r5)
        L_0x0052:
            return r5
        L_0x0053:
            r0.label = r3
        ...
        L_0x005c:
            ...
            java.lang.Object r5 = r5.m1568unboximpl()
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.AbstractChannel.m1545receiveCatchingJP2dKIU(kotlin.coroutines.Continuation):java.lang.Object");
    }

    /* renamed from: tryReceive-PtdJZtk  reason: not valid java name */
    public final Object m1546tryReceivePtdJZtk() {
        Object pollInternal = pollInternal();
        if (pollInternal == AbstractChannelKt.POLL_FAILED) {
            return ChannelResult.Companion.m1570failurePtdJZtk();
        }
        if (pollInternal instanceof Closed) {
            return ChannelResult.Companion.m1569closedJP2dKIU(((Closed) pollInternal).closeCause);
        }
        return ChannelResult.Companion.m1571successJP2dKIU(pollInternal);
    }
    ...
    public void onCancelIdempotent(boolean z) {
        ...
        if (closedForSend != null) {
            Object r0 = InlineList.m1593constructorimpl$default((Object) null, 1, (DefaultConstructorMarker) null);
            while (true) {
                LockFreeLinkedListNode prevNode = closedForSend.getPrevNode();
                if (prevNode instanceof LockFreeLinkedListHead) {
                    m1544onCancelIdempotentListww6eGU(r0, closedForSend);
                    return;
                    ...
                    r0 = InlineList.m1598plusFjFbRPM(r0, (Send) prevNode);
                }
            }
        } else {
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int i, Object obj) {
        ...
        if (z) {
            if (i == 0) {
                ...
                UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m1556boximpl(ChannelResult.Companion.m1569closedJP2dKIU(((Closed) obj).closeCause)), selectInstance.getCompletion());
            }
        } else if (i == 1) {
            ChannelResult.Companion companion = ChannelResult.Companion;
            UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m1556boximpl(z ? companion.m1569closedJP2dKIU(((Closed) obj).closeCause) : companion.m1571successJP2dKIU(obj)), selectInstance.getCompletion());
        } else {
            ...
            while (true) {
                ...
                if (pollInternal instanceof Closed) {
                    ...
                    if (closed.closeCause == null) {
                        ...
                        cancellableContinuation.resumeWith(Result.m58constructorimpl(Boxing.boxBoolean(false)));
                    } else {
                        Result.Companion companion2 = Result.Companion;
                        cancellableContinuation.resumeWith(Result.m58constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
                    }
                } else if (pollInternal != AbstractChannelKt.POLL_FAILED) {
                    Boolean boxBoolean = Boxing.boxBoolean(true);
                    Function1 function1 = this.channel.onUndeliveredElement;
                    cancellableContinuation.resume(boxBoolean, function1 != null ? OnUndeliveredElementKt.bindCancellationFun(function1, pollInternal, cancellableContinuation.getContext()) : null);
                }
            }
    ...
    private static class ReceiveElement<E> extends Receive<E> {
        ...
        public final Object resumeValue(E e) {
            return this.receiveMode == 1 ? ChannelResult.m1556boximpl(ChannelResult.Companion.m1571successJP2dKIU(e)) : e;
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode == 1) {
                ChannelResult r3 = ChannelResult.m1556boximpl(ChannelResult.Companion.m1569closedJP2dKIU(closed.closeCause));
                Result.Companion companion = Result.Companion;
                this.cont.resumeWith(Result.m58constructorimpl(r3));
                return;
            }
            Result.Companion companion2 = Result.Companion;
            this.cont.resumeWith(Result.m58constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
        }
    ...
    private static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        public void completeResumeReceive(E e) {
            CancellableKt.startCoroutineCancellable(this.block, this.receiveMode == 1 ? ChannelResult.m1556boximpl(ChannelResult.Companion.m1571successJP2dKIU(e)) : e, this.select.getCompletion(), resumeOnCancellationFun(e));
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.select.trySelect()) {
                ...
                if (i == 0) {
                    ...
                    CancellableKt.startCoroutineCancellable$default(this.block, ChannelResult.m1556boximpl(ChannelResult.Companion.m1569closedJP2dKIU(closed.closeCause)), this.select.getCompletion(), (Function1) null, 4, (Object) null);
                }
            }
        }
    ...
    public void m1544onCancelIdempotentListww6eGU(Object obj, Closed<?> closed) {
        if (obj == null) {
            return;
        }
