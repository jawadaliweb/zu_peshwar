...
public class ConfigAutoFetch {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:10:0x0045, code lost:
        if (r5.has(REALTIME_DISABLED_KEY) == false) goto L_0x005c;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:12:0x004b, code lost:
        if (r5.getBoolean(REALTIME_DISABLED_KEY) == false) goto L_0x005c;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:15:0x0060, code lost:
        if (isEventListenersEmpty() == false) goto L_0x0063;
     */
    ...
    private void handleNotifications(java.io.InputStream r10) throws java.io.IOException {
        ...
        L_0x0013:
            ...
            goto L_0x0013
        L_0x003c:
            org.json.JSONObject r5 = new org.json.JSONObject     // Catch:{ JSONException -> 0x007c }
            r5.<init>(r4)     // Catch:{ JSONException -> 0x007c }
            boolean r4 = r5.has(r1)     // Catch:{ JSONException -> 0x007c }
            if (r4 == 0) goto L_0x005c
            boolean r4 = r5.getBoolean(r1)     // Catch:{ JSONException -> 0x007c }
            if (r4 == 0) goto L_0x005c
            com.google.firebase.remoteconfig.ConfigUpdateListener r4 = r9.retryCallback     // Catch:{ JSONException -> 0x007c }
            com.google.firebase.remoteconfig.FirebaseRemoteConfigServerException r5 = new com.google.firebase.remoteconfig.FirebaseRemoteConfigServerException     // Catch:{ JSONException -> 0x007c }
            java.lang.String r6 = "The server is temporarily unavailable. Try again in a few minutes."
            com.google.firebase.remoteconfig.FirebaseRemoteConfigException$Code r7 = com.google.firebase.remoteconfig.FirebaseRemoteConfigException.Code.CONFIG_UPDATE_UNAVAILABLE     // Catch:{ JSONException -> 0x007c }
            r5.<init>((java.lang.String) r6, (com.google.firebase.remoteconfig.FirebaseRemoteConfigException.Code) r7)     // Catch:{ JSONException -> 0x007c }
            r4.onError(r5)     // Catch:{ JSONException -> 0x007c }
            goto L_0x0096
        L_0x005c:
            boolean r4 = r9.isEventListenersEmpty()     // Catch:{ JSONException -> 0x007c }
            if (r4 == 0) goto L_0x0063
            goto L_0x0096
        L_0x0063:
            boolean r4 = r5.has(r0)     // Catch:{ JSONException -> 0x007c }
            if (r4 == 0) goto L_0x0012
            com.google.firebase.remoteconfig.internal.ConfigFetchHandler r4 = r9.configFetchHandler     // Catch:{ JSONException -> 0x007c }
            long r6 = r4.getTemplateVersionNumber()     // Catch:{ JSONException -> 0x007c }
            long r4 = r5.getLong(r0)     // Catch:{ JSONException -> 0x007c }
            int r8 = (r4 > r6 ? 1 : (r4 == r6 ? 0 : -1))
            if (r8 <= 0) goto L_0x0012
            r6 = 3
            r9.autoFetch(r6, r4)     // Catch:{ JSONException -> 0x007c }
            goto L_0x0012
        L_0x007c:
            r4 = move-exception
    ...
    public synchronized Task<Void> fetchLatestConfig(int i, long j) {
        ...
        return Tasks.whenAllComplete((Task<?>[]) new Task[]{fetchNowWithTypeAndAttemptNumber, task}).continueWithTask(this.scheduledExecutorService, new Continuation(fetchNowWithTypeAndAttemptNumber, task, j, i2) {
            ...
            public final Object then(Task task) {
                return ConfigAutoFetch.this.lambda$fetchLatestConfig$0$ConfigAutoFetch(this.f$1, this.f$2, this.f$3, this.f$4, task);
            }
        });
    }

    public /* synthetic */ Task lambda$fetchLatestConfig$0$ConfigAutoFetch(Task task, Task task2, long j, int i, Task task3) throws Exception {
