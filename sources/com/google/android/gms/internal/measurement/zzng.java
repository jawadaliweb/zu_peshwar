...
class zzng extends AbstractMap {
    ...
    /* synthetic */ zzng(int i, zznf zznf) {
        this.zza = i;
    }
    ...
    public final Set entrySet() {
        if (this.zze == null) {
            this.zze = new zzne(this, (zznd) null);
        }
        return this.zze;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        int zzb2 = zzb();
        if (zzb2 != zzng.zzb()) {
            return entrySet().equals(zzng.entrySet());
        }
        for (int i = 0; i < zzb2; i++) {
            if (!zzg(i).equals(zzng.zzg(i))) {
                return false;
            }
        }
        if (zzb2 != size) {
            return this.zzc.equals(zzng.zzc);
        }
        return true;
    }
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int i2 = this.zza;
        if (size == i2) {
            zzna zzna = (zzna) this.zzb.remove(i2 - 1);
            zzm().put(zzna.zza(), zzna.getValue());
        }
