...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark m1365minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m1509minusLRDsOJo(this, j);
    }

    /* renamed from: getAdjustment-UwyO8pc  reason: not valid java name */
    public final long m1364getAdjustmentUwyO8pc() {
    ...
    public long m1363elapsedNowUwyO8pc() {
        return Duration.m1406minusLRDsOJo(this.mark.m1506elapsedNowUwyO8pc(), this.adjustment);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1366plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m1407plusLRDsOJo(this.adjustment, j), (DefaultConstructorMarker) null);
    }
}
