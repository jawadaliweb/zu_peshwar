...
public class FirebaseRemoteConfigValueImpl implements FirebaseRemoteConfigValue {
    ...
    public long asLong() {
        ...
        try {
            ...
            throw new IllegalArgumentException(String.format(ILLEGAL_ARGUMENT_STRING_FORMAT, new Object[]{asTrimmedString, LongTypedProperty.TYPE}), e);
        }
    }
    ...
    public double asDouble() {
        ...
        try {
            ...
            throw new IllegalArgumentException(String.format(ILLEGAL_ARGUMENT_STRING_FORMAT, new Object[]{asTrimmedString, DoubleTypedProperty.TYPE}), e);
        }
    }
