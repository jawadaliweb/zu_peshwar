    ...
    public final class RelaySource implements Source {
        ...
        public long read(okio.Buffer r20, long r21) throws java.io.IOException {
            ...
            L_0x0018:
                ...
                okhttp3.internal.cache2.Relay r4 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01c1 }
                long r6 = r4.getUpstreamPos()     // Catch:{ all -> 0x01c1 }
                okhttp3.internal.cache2.Relay r4 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01c1 }
                okio.Buffer r4 = r4.getBuffer()     // Catch:{ all -> 0x01c1 }
                long r9 = r4.size()     // Catch:{ all -> 0x01c1 }
                long r6 = r6 - r9
                long r9 = r1.sourcePos     // Catch:{ all -> 0x01c1 }
            ...
            L_0x0040:
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01c1 }
                long r9 = r0.getUpstreamPos()     // Catch:{ all -> 0x01c1 }
                long r11 = r1.sourcePos     // Catch:{ all -> 0x01c1 }
                long r9 = r9 - r11
                long r9 = java.lang.Math.min(r2, r9)     // Catch:{ all -> 0x01c1 }
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01c1 }
            ...
            L_0x0065:
                ...
                boolean r6 = r6.getComplete()     // Catch:{ all -> 0x01c1 }
                if (r6 == 0) goto L_0x006f
                monitor-exit(r8)
                return r11
            L_0x006f:
                okhttp3.internal.cache2.Relay r6 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01c1 }
                java.lang.Thread r6 = r6.getUpstreamReader()     // Catch:{ all -> 0x01c1 }
            ...
            L_0x007f:
                ...
                r6.setUpstreamReader(r7)     // Catch:{ all -> 0x01c1 }
            L_0x0088:
                monitor-exit(r8)
                r8 = 32
            ...
            L_0x00ae:
                ...
                java.lang.Thread r10 = (java.lang.Thread) r10     // Catch:{ all -> 0x00f4 }
            ...
            L_0x00f4:
                ...
                throw r0
            L_0x00f7:
                long r11 = java.lang.Math.min(r14, r2)     // Catch:{ all -> 0x019e }
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x019e }
                ...
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x019b }
                long r8 = r0.getBufferMaxSize()     // Catch:{ all -> 0x019b }
                ...
                okhttp3.internal.cache2.Relay r3 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x019b }
                long r8 = r3.getBufferMaxSize()     // Catch:{ all -> 0x019b }
                long r6 = r6 - r8
            ...
            L_0x016c:
                ...
                java.lang.Thread r10 = (java.lang.Thread) r10     // Catch:{ all -> 0x0198 }
                r0.setUpstreamReader(r10)     // Catch:{ all -> 0x0198 }
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0198 }
            ...
            L_0x019e:
                ...
                java.lang.Thread r10 = (java.lang.Thread) r10     // Catch:{ all -> 0x01be }
                r3.setUpstreamReader(r10)     // Catch:{ all -> 0x01be }
                okhttp3.internal.cache2.Relay r3 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01be }
