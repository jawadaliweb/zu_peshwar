...
public class PolystarContent implements PathContent, BaseKeyframeAnimation.AnimationListener, KeyPathElementContent {
    ...
    private void createStarPath() {
        ...
        double radians = Math.toRadians((baseKeyframeAnimation == null ? FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE : (double) baseKeyframeAnimation.getValue().floatValue()) - 90.0d);
