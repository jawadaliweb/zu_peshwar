    ...
    public void onMeasure(int i, int i2) {
        ...
        if (mode != 1073741824) {
            if (!isInEditMode()) {
                ...
                size = CacheLocation.EXTERNAL_CACHE_DIR;
            }
        } else if (mode2 == 0) {
            if (!isInEditMode()) {
                ...
                size2 = CacheLocation.EXTERNAL_CACHE_DIR;
            }
        }
        boolean z = false;
        ...
        while (true) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.width == -2) {
                    ...
                    i11 = View.MeasureSpec.makeMeasureSpec(paddingLeft - i15, BasicMeasure.EXACTLY);
                } else {
                    i11 = View.MeasureSpec.makeMeasureSpec(layoutParams.width, BasicMeasure.EXACTLY);
                }
                if (layoutParams.height == -2) {
                    i12 = View.MeasureSpec.makeMeasureSpec(i3, Integer.MIN_VALUE);
                } else if (layoutParams.height == -1) {
                    i12 = View.MeasureSpec.makeMeasureSpec(i3, BasicMeasure.EXACTLY);
                } else {
                    i12 = View.MeasureSpec.makeMeasureSpec(layoutParams.height, BasicMeasure.EXACTLY);
                }
                        ...
                        if (!z2 || childAt2 == this.mSlideableView) {
                            if (layoutParams2.weight > 0.0f) {
                                if (layoutParams2.width != 0) {
                                    i8 = View.MeasureSpec.makeMeasureSpec(childAt2.getMeasuredHeight(), BasicMeasure.EXACTLY);
                                    ...
                                    i8 = View.MeasureSpec.makeMeasureSpec(layoutParams2.height, BasicMeasure.EXACTLY);
                                }
                                if (z2) {
                                    int i18 = paddingLeft - (layoutParams2.leftMargin + layoutParams2.rightMargin);
                                    i6 = i16;
                                    int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(i18, BasicMeasure.EXACTLY);
                                    if (i7 != i18) {
                                    ...
                                    i6 = i16;
                                    childAt2.measure(View.MeasureSpec.makeMeasureSpec(i7 + ((int) ((layoutParams2.weight * ((float) Math.max(0, i13))) / f)), BasicMeasure.EXACTLY), i8);
                                    i17++;
                                    i16 = i6;
                                    i5 = 8;
                                }
                            ...
                            if (!z4) {
                                ...
                                i10 = View.MeasureSpec.makeMeasureSpec(childAt2.getMeasuredHeight(), BasicMeasure.EXACTLY);
                            } else if (layoutParams2.height == -2) {
                                i10 = View.MeasureSpec.makeMeasureSpec(i3, Integer.MIN_VALUE);
                                i9 = BasicMeasure.EXACTLY;
                            } else if (layoutParams2.height == -1) {
                                i9 = BasicMeasure.EXACTLY;
                                i10 = View.MeasureSpec.makeMeasureSpec(i3, BasicMeasure.EXACTLY);
                            } else {
                                i9 = BasicMeasure.EXACTLY;
                                i10 = View.MeasureSpec.makeMeasureSpec(layoutParams2.height, BasicMeasure.EXACTLY);
                            }
