...
public class Tutorial_A extends Fragment implements View.OnClickListener, IOnBackPressed {
    static int Title = 2131886361;
    Button Btn_Next;
    ...
    public void onClick(View view2) {
        ...
        if (id == R.id.Btn_Back) {
            ...
            this.activity.loadFragment(new Tutorial_B(), 1);
        }
    }
}
