...
public class LottieDrawable extends Drawable implements Drawable.Callback, Animatable {
    ...
    /* access modifiers changed from: package-private */
    public void setImageAssetManager(ImageAssetManager imageAssetManager2) {
        this.imageAssetManagerOverride = imageAssetManager2;
    }

    private ImageAssetManager getImageAssetManager() {
        ImageAssetManager imageAssetManager2 = this.imageAssetManagerOverride;
        if (imageAssetManager2 != null) {
        ...
        ImageAssetManager imageAssetManager3 = this.imageAssetManager;
        if (imageAssetManager3 != null && !imageAssetManager3.hasSameContext(getContext())) {
            this.imageAssetManager = null;
        }
