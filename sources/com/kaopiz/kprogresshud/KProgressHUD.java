    ...
    static /* synthetic */ class AnonymousClass2 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.kaopiz.kprogresshud.KProgressHUD.AnonymousClass2.<clinit>():void");
        }
    }

    public KProgressHUD setStyle(Style style) {
        View view;
        int i = AnonymousClass2.$SwitchMap$com$kaopiz$kprogresshud$KProgressHUD$Style[style.ordinal()];
        if (i == 1) {
