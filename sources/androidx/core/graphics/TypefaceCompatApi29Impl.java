...
public class TypefaceCompatApi29Impl extends TypefaceCompatBaseImpl {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:36:0x006c, code lost:
        r12 = androidx.constraintlayout.core.motion.utils.TypedValues.Transition.TYPE_DURATION;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:37:0x006f, code lost:
        r12 = com.kbeanie.multipicker.api.CacheLocation.INTERNAL_APP_DIR;
     */
    ...
    public Typeface createFromFontFamilyFilesResourceEntry(Context context, FontResourcesParserCompat.FontFamilyFilesResourceEntry fontFamilyFilesResourceEntry, Resources resources, int i) {
        try {
            ...
            int i5 = (i & 1) != 0 ? TypedValues.Transition.TYPE_DURATION : CacheLocation.INTERNAL_APP_DIR;
            if ((i & 2) != 0) {
                i2 = 1;
            }
