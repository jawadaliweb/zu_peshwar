...
public class OtpView extends AppCompatEditText {
    ...
    private static final int[] FILLED_STATE = {R.attr.state_filled};
    ...
    public OtpView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.otpViewItemCount = obtainStyledAttributes.getInt(R.styleable.OtpView_itemCount, 4);
        this.otpViewItemHeight = (int) obtainStyledAttributes.getDimension(R.styleable.OtpView_itemHeight, (float) resources.getDimensionPixelSize(R.dimen.otp_view_item_size));
        this.otpViewItemWidth = (int) obtainStyledAttributes.getDimension(R.styleable.OtpView_itemWidth, (float) resources.getDimensionPixelSize(R.dimen.otp_view_item_size));
        this.otpViewItemSpacing = obtainStyledAttributes.getDimensionPixelSize(R.styleable.OtpView_itemSpacing, resources.getDimensionPixelSize(R.dimen.otp_view_item_spacing));
        this.otpViewItemRadius = (int) obtainStyledAttributes.getDimension(R.styleable.OtpView_itemRadius, 0.0f);
        this.lineWidth = (int) obtainStyledAttributes.getDimension(R.styleable.OtpView_lineWidth, (float) resources.getDimensionPixelSize(R.dimen.otp_view_item_line_width));
        this.lineColor = obtainStyledAttributes.getColorStateList(R.styleable.OtpView_lineColor);
        this.isCursorVisible = obtainStyledAttributes.getBoolean(R.styleable.OtpView_android_cursorVisible, true);
        this.cursorColor = obtainStyledAttributes.getColor(R.styleable.OtpView_cursorColor, getCurrentTextColor());
        this.cursorWidth = obtainStyledAttributes.getDimensionPixelSize(R.styleable.OtpView_cursorWidth, resources.getDimensionPixelSize(R.dimen.otp_view_cursor_width));
        ...
        this.rtlTextDirection = obtainStyledAttributes.getBoolean(R.styleable.OtpView_rtlTextDirection, false);
    ...
    private void drawTextAtBox(Canvas canvas, Paint paint2, CharSequence charSequence, int i) {
        ...
        canvas.drawText(charSequence, i, i2, (f - (Math.abs((float) this.textRect.width()) / 2.0f)) - ((float) this.textRect.left), (f2 + (Math.abs((float) this.textRect.height()) / 2.0f)) - ((float) this.textRect.bottom), paint2);
    }
