...
public final class KotlinExtensions$await$2$2 implements Callback<T> {
    ...
    public void onResponse(Call<T> call, Response<T> response) {
        ...
        if (response.isSuccessful()) {
            ...
            if (body == null) {
                ...
                this.$continuation.resumeWith(Result.m58constructorimpl(ResultKt.createFailure(kotlinNullPointerException)));
                return;
            }
            Result.Companion companion2 = Result.Companion;
            this.$continuation.resumeWith(Result.m58constructorimpl(body));
            return;
        }
        Result.Companion companion3 = Result.Companion;
        this.$continuation.resumeWith(Result.m58constructorimpl(ResultKt.createFailure(new HttpException(response))));
    }
    ...
    public void onFailure(Call<T> call, Throwable th) {
        ...
        Result.Companion companion = Result.Companion;
        this.$continuation.resumeWith(Result.m58constructorimpl(ResultKt.createFailure(th)));
    }
}
