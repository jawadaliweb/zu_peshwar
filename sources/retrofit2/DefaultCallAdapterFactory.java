                ...
                public void onResponse(Call<T> call, Response<T> response) {
                    ...
                    /*  JADX ERROR: Method code generation error
                        jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x000b: INVOKE  
                         ...
                         java.util.concurrent.Executor.execute(java.lang.Runnable):void type: INTERFACE in method: retrofit2.DefaultCallAdapterFactory.ExecutorCallbackCall.1.onResponse(retrofit2.Call, retrofit2.Response):void, dex: classes2.dex
                ...
                public void onFailure(Call<T> call, Throwable th) {
                    ...
                    /*  JADX ERROR: Method code generation error
                        jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x000b: INVOKE  
                         ...
                         java.util.concurrent.Executor.execute(java.lang.Runnable):void type: INTERFACE in method: retrofit2.DefaultCallAdapterFactory.ExecutorCallbackCall.1.onFailure(retrofit2.Call, java.lang.Throwable):void, dex: classes2.dex
                        	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:256)
                        	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:221)
                        	at jadx.core.codegen.RegionGen.makeSimpleBlock(RegionGen.java:109)
                        	at jadx.core.codegen.RegionGen.makeRegion(RegionGen.java:55)
                        ...
                        Caused by: jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0008: CONSTRUCTOR  (r1v0 retrofit2.-$$Lambda$DefaultCallAdapterFactory$ExecutorCallbackCall$1$G9BY9eQQk64nBfFjfIpx-YzJzUo) = 
                         ...
                         retrofit2.DefaultCallAdapterFactory.ExecutorCallbackCall.1.val$callback retrofit2.Callback)
                          (r4v0 'th' java.lang.Throwable)
                         call: retrofit2.-$$Lambda$DefaultCallAdapterFactory$ExecutorCallbackCall$1$G9BY9eQQk64nBfFjfIpx-YzJzUo.<init>(retrofit2.DefaultCallAdapterFactory$ExecutorCallbackCall$1, retrofit2.Callback, java.lang.Throwable):void type: CONSTRUCTOR in method: retrofit2.DefaultCallAdapterFactory.ExecutorCallbackCall.1.onFailure(retrofit2.Call, java.lang.Throwable):void, dex: classes2.dex
                        	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:256)
                        	at jadx.core.codegen.InsnGen.addWrappedArg(InsnGen.java:123)
                        	at jadx.core.codegen.InsnGen.addArg(InsnGen.java:107)
                        	at jadx.core.codegen.InsnGen.generateMethodArguments(InsnGen.java:787)
