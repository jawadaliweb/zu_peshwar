...
public class FirebaseInstallations implements FirebaseInstallationsApi {
    ...
    FirebaseInstallations(FirebaseApp firebaseApp2, Provider<HeartBeatController> provider, ExecutorService executorService, Executor executor) {
        this(executorService, executor, firebaseApp2, new FirebaseInstallationServiceClient(firebaseApp2.getApplicationContext(), provider), new PersistedInstallation(firebaseApp2), Utils.getInstance(), new Lazy(new Provider() {
    ...
    static /* synthetic */ IidStore lambda$new$0(FirebaseApp firebaseApp2) {
    ...
    public Task<String> getId() {
        ...
        this.backgroundExecutor.execute(new Runnable() {
            public final void run() {
                FirebaseInstallations.this.lambda$getId$1$FirebaseInstallations();
            }
        });
        return addGetIdListener;
    }

    public /* synthetic */ void lambda$getId$1$FirebaseInstallations() {
        lambda$getToken$2$FirebaseInstallations(false);
    }
    ...
    public Task<InstallationTokenResult> getToken(boolean z) {
        ...
        this.backgroundExecutor.execute(new Runnable(z) {
            ...
            public final void run() {
                FirebaseInstallations.this.lambda$getToken$2$FirebaseInstallations(this.f$1);
            }
        });
    ...
    public final void lambda$getToken$2$FirebaseInstallations(boolean z) {
        ...
        this.networkExecutor.execute(new Runnable(z) {
            ...
            public final void run() {
                FirebaseInstallations.this.lambda$doRegistrationOrRefresh$3$FirebaseInstallations(this.f$1);
            }
        });
    }
    ...
    public void lambda$doRegistrationOrRefresh$3$FirebaseInstallations(boolean r3) {
        /*
            r2 = this;
        ...
        L_0x005f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.installations.FirebaseInstallations.lambda$doRegistrationOrRefresh$3$FirebaseInstallations(boolean):void");
    }
