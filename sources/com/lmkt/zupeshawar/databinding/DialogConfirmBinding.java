...
public final class DialogConfirmBinding implements ViewBinding {
    ...
    private DialogConfirmBinding(RelativeLayout relativeLayout, MaterialButton materialButton, LinearLayout linearLayout, MaterialButton materialButton2, TextView textView) {
        ...
        if (materialButton != null) {
            ...
            if (linearLayout != null) {
                ...
                if (materialButton2 != null) {
                    ...
                    if (textView != null) {
                        return new DialogConfirmBinding((RelativeLayout) view, materialButton, linearLayout, materialButton2, textView);
                    }
                }
            }
        }
