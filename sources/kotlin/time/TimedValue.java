...
public final class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m1529copyRFiDyg4$default(TimedValue timedValue, T t, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            t = timedValue.value;
        }
        if ((i & 2) != 0) {
        ...
        return timedValue.m1531copyRFiDyg4(t, j);
    }
    ...
    public final long m1530component2UwyO8pc() {
        return this.duration;
    }

    /* renamed from: copy-RFiDyg4  reason: not valid java name */
    public final TimedValue<T> m1531copyRFiDyg4(T t, long j) {
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.value, (Object) timedValue.value) && Duration.m1376equalsimpl0(this.duration, timedValue.duration);
    }

    public int hashCode() {
        T t = this.value;
        return ((t == null ? 0 : t.hashCode()) * 31) + Duration.m1399hashCodeimpl(this.duration);
    }

    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + Duration.m1420toStringimpl(this.duration) + ')';
    }
    ...
    public final long m1532getDurationUwyO8pc() {
        return this.duration;
    }
