...
final class StateFlowImpl<T> extends AbstractSharedFlow<StateFlowSlot> implements MutableStateFlow<T>, CancellableFlow<T>, FusibleFlow<T> {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:41:0x00bc A[Catch:{ all -> 0x0074 }] */
    /* JADX WARNING: Removed duplicated region for block: B:42:0x00be A[Catch:{ all -> 0x0074 }] */
    /* JADX WARNING: Removed duplicated region for block: B:45:0x00d1 A[Catch:{ all -> 0x0074 }, RETURN] */
    /* JADX WARNING: Removed duplicated region for block: B:46:0x00d2 A[Catch:{ all -> 0x0074 }] */
    /* JADX WARNING: Removed duplicated region for block: B:49:0x00d9 A[Catch:{ all -> 0x0074 }] */
    ...
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector<? super T> r11, kotlin.coroutines.Continuation<?> r12) {
        ...
        L_0x0077:
            ...
            boolean r2 = r11 instanceof kotlinx.coroutines.flow.SubscribedFlowCollector     // Catch:{ all -> 0x00ec }
            if (r2 == 0) goto L_0x0096
            r2 = r11
            kotlinx.coroutines.flow.SubscribedFlowCollector r2 = (kotlinx.coroutines.flow.SubscribedFlowCollector) r2     // Catch:{ all -> 0x00ec }
            r0.L$0 = r10     // Catch:{ all -> 0x00ec }
            r0.L$1 = r11     // Catch:{ all -> 0x00ec }
            r0.L$2 = r12     // Catch:{ all -> 0x00ec }
            r0.label = r6     // Catch:{ all -> 0x00ec }
            java.lang.Object r2 = r2.onSubscription(r0)     // Catch:{ all -> 0x00ec }
