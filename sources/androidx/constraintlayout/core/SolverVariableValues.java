...
public class SolverVariableValues implements ArrayRow.ArrayRowVariables {
    ...
    public void display() {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            if (variable != null) {
                ...
                printStream.print(variable + " = " + getVariableValue(i2) + MaskedEditText.SPACE);
            }
        }
        System.out.println(" }");
    }
    ...
    public String toString() {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            SolverVariable variable = getVariable(i2);
            if (variable != null) {
                String str4 = str3 + variable + " = " + getVariableValue(i2) + MaskedEditText.SPACE;
    ...
    private void displayHash() {
        for (int i = 0; i < this.HASH_SIZE; i++) {
            if (this.keys[i] != -1) {
                ...
                boolean z = false;
                while (!z) {
                    str = str + MaskedEditText.SPACE + this.variables[i2];
