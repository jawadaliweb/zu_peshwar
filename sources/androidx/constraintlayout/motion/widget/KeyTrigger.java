        ...
        if (str != null) {
            ...
            if (method == null) {
                try {
                    ...
                    Log.e(TypedValues.Trigger.NAME, "Could not find method \"" + str + "\"on class " + view.getClass().getSimpleName() + MaskedEditText.SPACE + Debug.getName(view));
                    return;
                }
            }
            try {
                ...
                Log.e(TypedValues.Trigger.NAME, "Exception in call \"" + this.mCross + "\"on class " + view.getClass().getSimpleName() + MaskedEditText.SPACE + Debug.getName(view));
            }
        }
    }
