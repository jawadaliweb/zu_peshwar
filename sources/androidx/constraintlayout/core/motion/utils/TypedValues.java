...
public interface TypedValues {
        ...
        public final /* synthetic */ class CC {
            public static int getType(int i) {
                ...
                switch (i) {
                    ...
                    default:
                        switch (i) {
                            case Cycle.TYPE_CURVE_FIT /*401*/:
                            case Cycle.TYPE_VISIBILITY /*402*/:
                                return 2;
                            case Cycle.TYPE_ALPHA /*403*/:
                                return 4;
                            default:
                                switch (i) {
                                    case Cycle.TYPE_WAVE_PERIOD /*423*/:
                                    case Cycle.TYPE_WAVE_OFFSET /*424*/:
    ...
    public interface Position {
        ...
        public final /* synthetic */ class CC {
            public static int getType(int i) {
                ...
                switch (i) {
                    case Position.TYPE_TRANSITION_EASING /*501*/:
                    case Position.TYPE_DRAWPATH /*502*/:
                        return 8;
                    case Position.TYPE_PERCENT_WIDTH /*503*/:
                    case 504:
                    case Position.TYPE_SIZE_PERCENT /*505*/:
                    case Position.TYPE_PERCENT_X /*506*/:
                    case Position.TYPE_PERCENT_Y /*507*/:
                        return 4;
                    case 508:
                        return 2;
                    default:
    ...
    public interface Custom {
        public static final String[] KEY_WORDS = {S_FLOAT, S_COLOR, "string", "boolean", S_DIMENSION, S_REFERENCE};
        ...
        public final /* synthetic */ class CC {
            ...
            public static int getId(java.lang.String r2) {
                ...
                L_0x007e:
                    ...
                    return r2
                */
                throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.core.motion.utils.TypedValues.Transition.CC.getId(java.lang.String):int");
            }
        }
    }
}
