...
interface zzaia {
    ...
    @Deprecated
    void zzC(List list, zzaib zzaib, zzafx zzafx) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzaib zzaib, zzafx zzafx) throws IOException;
    ...
    zzaff zzp() throws IOException;

    String zzr() throws IOException;

    String zzs() throws IOException;

    void zzt(Object obj, zzaib zzaib, zzafx zzafx) throws IOException;

    void zzu(Object obj, zzaib zzaib, zzafx zzafx) throws IOException;
