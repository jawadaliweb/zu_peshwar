...
public class RideHistory extends Fragment implements View.OnClickListener, IOnBackPressed, APIManager.Callback {
    static int Title = 2131886367;
    EditText ET_from;
    EditText ET_to;
    ...
    private void setDateListener() {
        this.to_DatePicker = new DatePickerDialog.OnDateSetListener() {
            public final void onDateSet(DatePicker datePicker, int i, int i2, int i3) {
                RideHistory.this.lambda$setDateListener$0$RideHistory(datePicker, i, i2, i3);
            }
        };
        this.from_DatePicker = new DatePickerDialog.OnDateSetListener() {
            public final void onDateSet(DatePicker datePicker, int i, int i2, int i3) {
                RideHistory.this.lambda$setDateListener$1$RideHistory(datePicker, i, i2, i3);
            }
        };
    }

    public /* synthetic */ void lambda$setDateListener$0$RideHistory(DatePicker datePicker, int i, int i2, int i3) {
        try {
            ...
            if (!obj2.isEmpty()) {
                ...
                APIManager.getInstance().getBSSTravelHistory(this, obj2, obj, getContext());
                return;
            }
    ...
    public /* synthetic */ void lambda$setDateListener$1$RideHistory(DatePicker datePicker, int i, int i2, int i3) {
        try {
            this.myCalendar.set(1, i);
            this.myCalendar.set(2, i2);
            this.myCalendar.set(5, i3);
        ...
        if (this.travelHistories != null) {
            ...
            try {
                ...
                while (it.hasNext()) {
                    ...
                    new ArrHistoryData();
                    jSONObject4.accumulate("checkinStation", next.getRentSite());
                    jSONObject4.accumulate("checkintime", next.getRentoutTime());
                    jSONObject4.accumulate("checkoutStation", next.getReturnSite());
                    jSONObject4.accumulate("checkouttime", next.getReturnTime());
                    String date = next.getDate();
                    Objects.requireNonNull(date);
                    if (date.isEmpty()) {
                        jSONObject4.accumulate("date", "N/A");
                    } else {
                ...
                if (!obj.isEmpty()) {
                    if (!obj2.isEmpty()) {
                        ...
                        jSONObject.put(CommonProperties.TYPE, "Bicycle Transaction History");
                        ...
                        APIManager.getInstance().downloadTransactionPDF(new APIManager.StreamResp() {
                            ...
                            public void onFailure(int i, String str) {
                                RideHistory.this.activity.appAlerts.dismiss();
                                RideHistory.this.activity.appAlerts.showAlertDialog(RideHistory.this.activity, str, "Alert", new AppAlertDialog.AlertDialogListener() {
                                    public final void onClicked() {
                                        RideHistory.AnonymousClass1.this.lambda$onFailure$0$RideHistory$1();
                                    }
                                });
                            }

                            public /* synthetic */ void lambda$onFailure$0$RideHistory$1() {
                                RideHistory.this.activity.appAlerts.dismiss();
                            }
                ...
                this.activity.appAlerts.showAlertDialog(this.activity, e.getMessage(), "Alert", new AppAlertDialog.AlertDialogListener() {
                    public final void onClicked() {
                        RideHistory.this.lambda$downloadPDF$2$RideHistory();
                    }
                });
            }
        }
    ...
    public /* synthetic */ void lambda$downloadPDF$2$RideHistory() {
        this.activity.appAlerts.dismiss();
    }
    ...
    class DownloadFile extends AsyncTask<Void, Void, String> {
        ...
        public String doInBackground(Void... voidArr) {
            ...
            try {
                openFileOutput = RideHistory.this.context.openFileOutput(this.filePath, 0);
        ...
        public void onPostExecute(String str) {
            RideHistory.this.activity.appAlerts.showSuccessDialog(RideHistory.this.activity, "Pdf is generated Successfully.\n", new AppAlertDialog.AlertDialogListener() {
                public final void onClicked() {
                    RideHistory.DownloadFile.this.lambda$onPostExecute$0$RideHistory$DownloadFile();
                }
            });
        }

        public /* synthetic */ void lambda$onPostExecute$0$RideHistory$DownloadFile() {
            RideHistory.this.openFile(new File(RideHistory.this.context.getFilesDir(), this.filePath));
            RideHistory.this.activity.appAlerts.dismiss();
        }
    }
    ...
    private void initToolbar() {
        ...
        this.context = bicycleMenuItem.getBaseContext();
    ...
    private void initTravelHistory_List() {
        ...
        this.activity.appAlerts.showPleaseWait(this.activity);
        APIManager.getInstance().getBSSTravelHistory(this, "", "", getContext());
    }
        ...
        if (i == ReturnCodes.Companion.OK()) {
            ...
            this.activity.runOnUiThread(new Runnable() {
                public final void run() {
                    RideHistory.this.lambda$onSuccess$3$RideHistory();
                }
            });
            ...
            this.activity.appAlerts.showErrorDialog(this.activity, apiResponse.getRespMessage(), new AppAlertDialog.AlertDialogListener() {
                public final void onClicked() {
                    RideHistory.this.lambda$onSuccess$4$RideHistory();
                }
            });
        }
    }

    public /* synthetic */ void lambda$onSuccess$3$RideHistory() {
    ...
    public /* synthetic */ void lambda$onSuccess$4$RideHistory() {
        this.activity.appAlerts.dismiss();
    }
    ...
    public void onFailure(int i, String str) {
        ...
        if (i == ReturnCodes.Companion.INVALID_DEVICE()) {
            ...
            this.activity.appAlerts.showErrorDialog(this.activity, str, new AppAlertDialog.AlertDialogListener() {
                public final void onClicked() {
                    RideHistory.this.lambda$onFailure$5$RideHistory();
                }
            });
        }
    }

    public /* synthetic */ void lambda$onFailure$5$RideHistory() {
        this.activity.appAlerts.dismiss();
    }
    ...
    public class ListAdapter extends ArrayAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            ((TextView) inflate.findViewById(R.id.checkinStation_TV)).setText(travelHistory.getRentSite());
            ((TextView) inflate.findViewById(R.id.checkoutStation_TV)).setText(travelHistory.getRentSite());
            try {
                SimpleDateFormat simpleDateFormat2 = new SimpleDateFormat("hh:mm aa");
                String rentoutTime = travelHistory.getRentoutTime();
                Objects.requireNonNull(rentoutTime);
                Date parse = simpleDateFormat.parse(rentoutTime);
                String returnTime = travelHistory.getReturnTime();
                Objects.requireNonNull(returnTime);
                Date parse2 = simpleDateFormat.parse(returnTime);
