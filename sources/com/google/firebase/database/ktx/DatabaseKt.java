...
public final class DatabaseKt {
    ...
    public static final FirebaseDatabase database(Firebase firebase, String str) {
        ...
        FirebaseDatabase instance = FirebaseDatabase.getInstance(str);
    ...
    public static final FirebaseDatabase database(Firebase firebase, FirebaseApp firebaseApp, String str) {
        ...
        Intrinsics.checkNotNullParameter(firebaseApp, "app");
        Intrinsics.checkNotNullParameter(str, ImagesContract.URL);
        FirebaseDatabase instance = FirebaseDatabase.getInstance(firebaseApp, str);
    ...
    public static final /* synthetic */ <T> T getValue(DataSnapshot dataSnapshot) {
        ...
        return dataSnapshot.getValue(new DatabaseKt$getValue$1());
    }

    public static final /* synthetic */ <T> T getValue(MutableData mutableData) {
        Intrinsics.checkNotNullParameter(mutableData, "<this>");
        Intrinsics.needClassReification();
        return mutableData.getValue(new DatabaseKt$getValue$2());
    }

    public static final Flow<DataSnapshot> getSnapshots(Query query) {
        Intrinsics.checkNotNullParameter(query, "<this>");
        return FlowKt.callbackFlow(new DatabaseKt$snapshots$1(query, (Continuation<? super DatabaseKt$snapshots$1>) null));
    }

    public static final Flow<ChildEvent> getChildEvents(Query query) {
        Intrinsics.checkNotNullParameter(query, "<this>");
        return FlowKt.callbackFlow(new DatabaseKt$childEvents$1(query, (Continuation<? super DatabaseKt$childEvents$1>) null));
    }
}
