...
final class zzkf extends zzki {
    ...
    public final void zze(int i, zzka zzka) throws IOException {
        zzq((i << 3) | 2);
        zzq(zzka.zzd());
        zzka.zzh(this);
    }
    ...
    public final void zzg(int i) throws IOException {
        try {
            ...
            throw new zzkg(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.zze), Integer.valueOf(this.zzd), 1}), e);
        }
    }
    ...
    public final void zzc(byte[] bArr, int i, int i2) throws IOException {
        try {
            ...
            throw new zzkg(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.zze), Integer.valueOf(this.zzd), Integer.valueOf(i2)}), e);
        }
    }
    ...
    public final void zzs(long j) throws IOException {
        if (!zzki.zzd || this.zzd - this.zze < 10) {
            ...
            while ((j & -128) != 0) {
                ...
                int i3 = this.zze;
                this.zze = i3 + 1;
                zznu.zzn(bArr3, (long) i3, (byte) ((((int) j) & 127) | 128));
                j >>>= 7;
            }
            byte[] bArr4 = this.zzc;
            int i4 = this.zze;
            this.zze = i4 + 1;
            zznu.zzn(bArr4, (long) i4, (byte) ((int) j));
        }
    }
}
