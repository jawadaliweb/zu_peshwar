...
public class ConstraintLayoutStates {
    ...
    private void parseConstraintSet(Context context, XmlPullParser xmlPullParser) {
        ...
        while (i2 < attributeCount) {
            ...
            if (attributeName == null || attributeValue == null || !CommonProperties.ID.equals(attributeName)) {
                i2++;
            } else {
                if (attributeValue.contains("/")) {
                    i = context.getResources().getIdentifier(attributeValue.substring(attributeValue.indexOf(47) + 1), CommonProperties.ID, context.getPackageName());
                } else {
                    i = -1;
                }
                if (i == -1) {
