...
public final class Request {
    ...
    public final <T> T tag(Class<? extends T> cls) {
        Intrinsics.checkNotNullParameter(cls, CommonProperties.TYPE);
    ...
    public final HttpUrl m1730deprecated_url() {
        return this.url;
    }
    ...
    public final String m1729deprecated_method() {
        return this.method;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "headers", imports = {}))
    /* renamed from: -deprecated_headers  reason: not valid java name */
    public final Headers m1728deprecated_headers() {
        return this.headers;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "body", imports = {}))
    /* renamed from: -deprecated_body  reason: not valid java name */
    public final RequestBody m1726deprecated_body() {
        return this.body;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "cacheControl", imports = {}))
    /* renamed from: -deprecated_cacheControl  reason: not valid java name */
    public final CacheControl m1727deprecated_cacheControl() {
        return cacheControl();
    }
    ...
    public static class Builder {
        ...
        public Builder url(URL url2) {
            Intrinsics.checkNotNullParameter(url2, ImagesContract.URL);
        ...
        public Builder delete(RequestBody requestBody) {
            return method(DefaultHttpClient.METHOD_DELETE, requestBody);
        }
