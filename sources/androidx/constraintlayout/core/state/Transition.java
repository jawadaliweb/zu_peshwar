...
public class Transition {
    ...
    private int mDuration = CacheLocation.INTERNAL_APP_DIR;
    ...
    public void addKeyPosition(String str, int i, int i2, float f, float f2) {
        ...
        typedBundle.add((int) TypedValues.Position.TYPE_POSITION_TYPE, 2);
        typedBundle.add(100, i);
        typedBundle.add((int) TypedValues.Position.TYPE_PERCENT_X, f);
        typedBundle.add((int) TypedValues.Position.TYPE_PERCENT_Y, f2);
        getWidgetState(str, (ConstraintWidget) null, 0).setKeyPosition(typedBundle);
