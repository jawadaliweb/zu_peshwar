...
public class Base64 extends BaseNCodec {
    ...
    private long validateCharacter(int i, BaseNCodec.Context context) {
        if ((context.ibitWorkArea & i) == 0) {
            return (long) (context.ibitWorkArea >> i);
        }
