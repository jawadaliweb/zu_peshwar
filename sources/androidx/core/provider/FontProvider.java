    ...
    private static final Comparator<byte[]> sByteArrayComparator = new Comparator<byte[]>() {
        ...
        public int compare(byte[] r5, byte[] r6) {
            ...
            L_0x001b:
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.core.provider.FontProvider.AnonymousClass1.compare(byte[], byte[]):int");
        }
    };
        ...
        try {
            ...
            if (cursor != null && cursor.getCount() > 0) {
                ...
                while (cursor.moveToNext()) {
                    ...
                    arrayList2.add(FontsContractCompat.FontInfo.create(uri, i3, columnIndex5 != -1 ? cursor.getInt(columnIndex5) : CacheLocation.INTERNAL_APP_DIR, columnIndex6 != -1 && cursor.getInt(columnIndex6) == 1, i));
                }
