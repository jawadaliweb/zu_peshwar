    ...
    private void doWriteToLog(long j, String str) {
        if (this.logFile != null) {
            ...
            try {
                ...
                this.logFile.add(String.format(Locale.US, "%d %s%n", new Object[]{Long.valueOf(j), str.replaceAll("\r", MaskedEditText.SPACE).replaceAll("\n", MaskedEditText.SPACE)}).getBytes(UTF_8));
