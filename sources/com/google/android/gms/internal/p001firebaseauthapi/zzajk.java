...
final class zzajk {
    private static final zzajh zza = new zzaji();
    ...
    static int zzb(java.lang.CharSequence r7, byte[] r8, int r9, int r10) {
        ...
        L_0x00bb:
            r1 = r4
        L_0x00bc:
            com.google.android.gms.internal.firebase-auth-api.zzajj r7 = new com.google.android.gms.internal.firebase-auth-api.zzajj
            int r1 = r1 + -1
            r7.<init>(r1, r0)
            throw r7
        L_0x00c4:
        ...
        L_0x00ff:
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p001firebaseauthapi.zzajk.zzb(java.lang.CharSequence, byte[], int, int):int");
    }
    ...
    static String zzd(byte[] bArr, int i, int i2) throws zzags {
        int i3;
        ...
        if ((((length - i) - i2) | i | i2) >= 0) {
            ...
            while (r11 < i4) {
                ...
                if (zzajg.zzd(b2)) {
                    ...
                    if (i6 < i4 - 1) {
                        int i8 = i6 + 1;
                        zzajg.zzb(b2, bArr[i6], bArr[i8], cArr, i3);
                        r11 = i8 + 1;
                        i3++;
                    } else {
                        throw zzags.zzd();
                    ...
                    byte b4 = bArr[i6];
                    int i10 = i9 + 1;
                    zzajg.zza(b2, b4, bArr[i9], bArr[i10], cArr, i3);
                    i3 += 2;
                    r11 = i10 + 1;
                } else {
                    throw zzags.zzd();
