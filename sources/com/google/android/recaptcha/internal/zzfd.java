...
final class zzfd extends zzff {
    ...
    /* synthetic */ zzfd(InputStream inputStream, int i, zzfc zzfc) {
        super((zzfe) null);
        byte[] bArr = zzgw.zzd;
    ...
    public final zzez zzw() throws IOException {
        ...
        int i2 = this.zzi;
        if (zzj2 <= i - i2 && zzj2 > 0) {
            zzez zzm = zzez.zzm(this.zzf, i2, zzj2);
            this.zzi += zzj2;
            return zzm;
        } else if (zzj2 == 0) {
            return zzez.zzb;
    ...
    public final String zzx() throws IOException {
        ...
        if (zzj2 > 0) {
            ...
            int i2 = this.zzi;
            if (zzj2 <= i - i2) {
                String str = new String(this.zzf, i2, zzj2, zzgw.zzb);
                this.zzi += zzj2;
                return str;
            }
        }
        ...
        if (zzj2 > this.zzg) {
            return new String(zzM(zzj2, false), zzgw.zzb);
        }
        zzK(zzj2);
        String str2 = new String(this.zzf, this.zzi, zzj2, zzgw.zzb);
        this.zzi += zzj2;
        return str2;
    }
