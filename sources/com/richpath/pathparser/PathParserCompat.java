...
public class PathParserCompat {
    ...
    public static boolean canMorph(PathDataNode[]... pathDataNodeArr) {
        ...
        int i = 0;
        while (i < pathDataNodeArr.length - 1) {
            int length = pathDataNodeArr[i].length;
            i++;
            if (length != pathDataNodeArr[i].length) {
                return false;
            }
        }
        for (int i2 = 0; i2 < pathDataNodeArr.length - 1; i2++) {
            for (int i3 = 0; i3 < pathDataNodeArr[i2].length; i3++) {
                int i4 = i2 + 1;
                if (pathDataNodeArr[i2][i3].type != pathDataNodeArr[i4][i3].type || pathDataNodeArr[i2][i3].params.length != pathDataNodeArr[i4][i3].params.length) {
                    return false;
                }
            }
        }
    ...
    private static void extract(java.lang.String r8, int r9, com.richpath.pathparser.PathParserCompat.ExtractFloatResult r10) {
        /*
            r0 = 0
