...
public final class zay extends GoogleApi implements ModuleInstallClient {
    ...
    public final Task<ModuleInstallResponse> installModules(ModuleInstallRequest moduleInstallRequest) {
        ...
        if (listenerExecutor == null) {
            listenerHolder = registerListener(listener, InstallStatusListener.class.getSimpleName());
        } else {
            listenerHolder = ListenerHolders.createListenerHolder(listener, listenerExecutor, InstallStatusListener.class.getSimpleName());
        }
        ListenerHolder listenerHolder2 = listenerHolder;
        zaab zaab = new zaab(listenerHolder2);
        ...
        builder2.withHolder(listenerHolder2);
