...
public class ConfigCacheClient {
    private static final Executor DIRECT_EXECUTOR = $$Lambda$PNiE7SuEFxRjAZH7pJpZIFOFjWg.INSTANCE;
    ...
    public Task<ConfigContainer> put(ConfigContainer configContainer, boolean z) {
        return Tasks.call(this.executor, new Callable(configContainer) {
        ...
        }).onSuccessTask(this.executor, new SuccessContinuation(z, configContainer) {
    ...
    public synchronized Task<ConfigContainer> get() {
        ...
        if (task == null || (task.isComplete() && !this.cachedContainerTask.isSuccessful())) {
            ...
            this.cachedContainerTask = Tasks.call(executor2, new Callable() {
                public final Object call() {
