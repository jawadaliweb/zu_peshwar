...
final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m1583debounceHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.debounce(flow, DelayKt.m1536toDelayMillisLRDsOJo(j));
    }
    ...
    public static final <T> Flow<T> m1584sampleHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.sample(flow, DelayKt.m1536toDelayMillisLRDsOJo(j));
    }
}
