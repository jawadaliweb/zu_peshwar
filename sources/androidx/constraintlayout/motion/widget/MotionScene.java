...
public class MotionScene {
    ...
    /* access modifiers changed from: private */
    public int mDefaultDuration = CacheLocation.INTERNAL_APP_DIR;
    ...
    public static class Transition {
        ...
        /* access modifiers changed from: private */
        public int mDuration = CacheLocation.INTERNAL_APP_DIR;
        /* access modifiers changed from: private */
        public int mId = -1;
        /* access modifiers changed from: private */
    ...
    private int getId(Context context, String str) {
        int i;
        if (str.contains("/")) {
            i = context.getResources().getIdentifier(str.substring(str.indexOf(47) + 1), CommonProperties.ID, context.getPackageName());
    ...
    public void processTouchEvent(MotionEvent motionEvent, int i, MotionLayout motionLayout) {
        ...
        if (i != -1) {
            ...
            if (action == 0) {
                ...
                if ((((double) rawX) != FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE || ((double) rawY) != FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE) && (motionEvent2 = this.mLastTouchDown) != null) {
