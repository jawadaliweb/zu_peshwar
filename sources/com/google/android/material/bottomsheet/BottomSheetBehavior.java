            ...
            if (f2 < 0.0f) {
                if (BottomSheetBehavior.this.fitToContents) {
                    ...
                    if (BottomSheetBehavior.this.shouldSkipHalfExpandedStateWhenDragging()) {
                        if (BottomSheetBehavior.this.shouldExpandOnUpwardDrag(currentTimeMillis, (((float) top) * 100.0f) / ((float) BottomSheetBehavior.this.parentHeight))) {
                            i = BottomSheetBehavior.this.expandedOffset;
                        } else {
                            i2 = BottomSheetBehavior.this.collapsedOffset;
                            i3 = 4;
                            BottomSheetBehavior bottomSheetBehavior = BottomSheetBehavior.this;
                            bottomSheetBehavior.startSettlingAnimation(view, i3, i, bottomSheetBehavior.shouldSkipSmoothAnimation());
                        }
                    } else if (top > BottomSheetBehavior.this.halfExpandedOffset) {
                        i = BottomSheetBehavior.this.halfExpandedOffset;
                        BottomSheetBehavior bottomSheetBehavior2 = BottomSheetBehavior.this;
                        bottomSheetBehavior2.startSettlingAnimation(view, i3, i, bottomSheetBehavior2.shouldSkipSmoothAnimation());
                    } else {
                ...
                if (f2 == 0.0f || Math.abs(f) > Math.abs(f2)) {
                    ...
                    if (BottomSheetBehavior.this.fitToContents) {
                        if (Math.abs(top2 - BottomSheetBehavior.this.fitToContentsOffset) < Math.abs(top2 - BottomSheetBehavior.this.collapsedOffset)) {
                            ...
                            i2 = BottomSheetBehavior.this.collapsedOffset;
                            i3 = 4;
                            BottomSheetBehavior bottomSheetBehavior22 = BottomSheetBehavior.this;
                            bottomSheetBehavior22.startSettlingAnimation(view, i3, i, bottomSheetBehavior22.shouldSkipSmoothAnimation());
                        }
                        ...
                        if (Math.abs(top2 - BottomSheetBehavior.this.halfExpandedOffset) >= Math.abs(top2 - BottomSheetBehavior.this.collapsedOffset)) {
                            ...
                            i = BottomSheetBehavior.this.halfExpandedOffset;
                            BottomSheetBehavior bottomSheetBehavior222 = BottomSheetBehavior.this;
                            bottomSheetBehavior222.startSettlingAnimation(view, i3, i, bottomSheetBehavior222.shouldSkipSmoothAnimation());
                        }
                        i3 = 4;
                        BottomSheetBehavior bottomSheetBehavior2222 = BottomSheetBehavior.this;
                        bottomSheetBehavior2222.startSettlingAnimation(view, i3, i, bottomSheetBehavior2222.shouldSkipSmoothAnimation());
                    } else if (top2 < Math.abs(top2 - BottomSheetBehavior.this.collapsedOffset)) {
                        i = BottomSheetBehavior.this.getExpandedOffset();
                    } else if (BottomSheetBehavior.this.shouldSkipHalfExpandedStateWhenDragging()) {
                        i2 = BottomSheetBehavior.this.collapsedOffset;
                        i3 = 4;
                        BottomSheetBehavior bottomSheetBehavior22222 = BottomSheetBehavior.this;
                        bottomSheetBehavior22222.startSettlingAnimation(view, i3, i, bottomSheetBehavior22222.shouldSkipSmoothAnimation());
                    } else {
                        i = BottomSheetBehavior.this.halfExpandedOffset;
                        BottomSheetBehavior bottomSheetBehavior222222 = BottomSheetBehavior.this;
                        bottomSheetBehavior222222.startSettlingAnimation(view, i3, i, bottomSheetBehavior222222.shouldSkipSmoothAnimation());
                    }
                } else {
                    if (BottomSheetBehavior.this.fitToContents) {
                        i2 = BottomSheetBehavior.this.collapsedOffset;
                        ...
                        if (Math.abs(top3 - BottomSheetBehavior.this.halfExpandedOffset) >= Math.abs(top3 - BottomSheetBehavior.this.collapsedOffset)) {
                            ...
                            i = BottomSheetBehavior.this.halfExpandedOffset;
                            BottomSheetBehavior bottomSheetBehavior2222222 = BottomSheetBehavior.this;
                            bottomSheetBehavior2222222.startSettlingAnimation(view, i3, i, bottomSheetBehavior2222222.shouldSkipSmoothAnimation());
                        }
                    }
                    i3 = 4;
                    BottomSheetBehavior bottomSheetBehavior22222222 = BottomSheetBehavior.this;
                    bottomSheetBehavior22222222.startSettlingAnimation(view, i3, i, bottomSheetBehavior22222222.shouldSkipSmoothAnimation());
                }
            } else if ((Math.abs(f) < Math.abs(f2) && f2 > 500.0f) || releasedLow(view)) {
                i = BottomSheetBehavior.this.parentHeight;
                i3 = 5;
                BottomSheetBehavior bottomSheetBehavior222222222 = BottomSheetBehavior.this;
                bottomSheetBehavior222222222.startSettlingAnimation(view, i3, i, bottomSheetBehavior222222222.shouldSkipSmoothAnimation());
                ...
                i = BottomSheetBehavior.this.halfExpandedOffset;
                BottomSheetBehavior bottomSheetBehavior2222222222 = BottomSheetBehavior.this;
                bottomSheetBehavior2222222222.startSettlingAnimation(view, i3, i, bottomSheetBehavior2222222222.shouldSkipSmoothAnimation());
            }
            i3 = 3;
            BottomSheetBehavior bottomSheetBehavior22222222222 = BottomSheetBehavior.this;
            bottomSheetBehavior22222222222.startSettlingAnimation(view, i3, i, bottomSheetBehavior22222222222.shouldSkipSmoothAnimation());
        }
