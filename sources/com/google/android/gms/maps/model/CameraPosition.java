...
public final class CameraPosition extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public String toString() {
        return Objects.toStringHelper(this).add(TypedValues.Attributes.S_TARGET, this.target).add("zoom", Float.valueOf(this.zoom)).add("tilt", Float.valueOf(this.tilt)).add("bearing", Float.valueOf(this.bearing)).toString();
    }
