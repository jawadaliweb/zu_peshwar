...
public class Repo implements PersistentConnection.Delegate {
    ...
    public void onDataUpdate(List<String> list, Object obj, boolean z, Long l) {
        ...
        if (this.dataLogger.logsDebug()) {
            this.operationLogger.debug("onDataUpdate: " + path + MaskedEditText.SPACE + obj, new Object[0]);
        }
    ...
    public void onRangeMergeUpdate(List<String> list, List<RangeMerge> list2, Long l) {
        ...
        if (this.dataLogger.logsDebug()) {
            this.operationLogger.debug("onRangeMergeUpdate: " + path + MaskedEditText.SPACE + list2, new Object[0]);
        }
        this.dataUpdateCount++;
    ...
    public void setValue(Path path, Node node, DatabaseReference.CompletionListener completionListener) {
        ...
        if (this.dataLogger.logsDebug()) {
            ...
            logWrapper2.debug("set: " + path + MaskedEditText.SPACE + node, new Object[0]);
        }
        ...
        scheduleNow(new Runnable() {
            public void run() {
                ...
                if (persistenceServerCache.exists()) {
                    Repo.this.scheduleDelayed(new Runnable(persistenceServerCache) {
                        ...
                        public final void run() {
                            TaskCompletionSource.this.trySetResult(this.f$1);
                        }
                    }, 3000);
                }
                Repo.this.connection.get(query.getPath().asList(), query.getSpec().getParams().getWireProtocolParams()).addOnCompleteListener((Executor) ((DefaultRunLoop) Repo.this.ctx.getRunLoop()).getExecutorService(), new OnCompleteListener(taskCompletionSource, persistenceServerCache, query, this) {
                    ...
                    public final void onComplete(Task task) {
                        Repo.AnonymousClass9.this.lambda$run$1$Repo$9(this.f$1, this.f$2, this.f$3, this.f$4, task);
                    }
                });
            }
    ...
    public void updateChildren(Path path, CompoundWrite compoundWrite, DatabaseReference.CompletionListener completionListener, Map<String, Object> map) {
        ...
        if (this.dataLogger.logsDebug()) {
            LogWrapper logWrapper2 = this.dataLogger;
            logWrapper2.debug("update: " + path2 + MaskedEditText.SPACE + map2, new Object[0]);
        }
