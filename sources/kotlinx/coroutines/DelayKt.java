...
public final class DelayKt {
    ...
    public static final Object m1535delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m1536toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1536toDelayMillisLRDsOJo(long j) {
        if (Duration.m1370compareToLRDsOJo(j, Duration.Companion.m1473getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1389getInWholeMillisecondsimpl(j), 1);
        }
        return 0;
    }
}
