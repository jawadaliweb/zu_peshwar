...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    private static class MyTracker implements MotionTracker {
        ...
        private static MyTracker f5me = new MyTracker();
        ...
        public static MyTracker obtain() {
            f5me.tracker = VelocityTracker.obtain();
            return f5me;
        }
    ...
    class Model {
        ...
        private void debugLayout(String str, ConstraintWidgetContainer constraintWidgetContainer) {
            String str2 = str + MaskedEditText.SPACE + Debug.getName((View) constraintWidgetContainer.getCompanionWidget());
            ...
            for (int i = 0; i < size; i++) {
                ...
                Log.v(MotionLayout.TAG, str3 + "  " + name + MaskedEditText.SPACE + constraintWidget + MaskedEditText.SPACE + sb8);
            }
        ...
        public void draw(Canvas canvas, HashMap<View, MotionController> hashMap, int i, int i2) {
            if (hashMap != null && hashMap.size() != 0) {
                ...
                if (!MotionLayout.this.isInEditMode() && (i2 & 1) == 2) {
                    String str = MotionLayout.this.getContext().getResources().getResourceName(MotionLayout.this.mEndState) + Constants.COMMON_SCHEMA_PREFIX_SEPARATOR + MotionLayout.this.getProgress();
    ...
    private void debugPos() {
        for (int i = 0; i < getChildCount(); i++) {
            View childAt = getChildAt(i);
            Log.v(TAG, MaskedEditText.SPACE + Debug.getLocation() + MaskedEditText.SPACE + Debug.getName(this) + MaskedEditText.SPACE + Debug.getName(getContext(), this.mCurrentState) + MaskedEditText.SPACE + Debug.getName(childAt) + childAt.getLeft() + MaskedEditText.SPACE + childAt.getTop());
        }
    }
