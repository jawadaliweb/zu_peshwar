...
public final class i {
    static Pair<ByteBuffer, Long> a(RandomAccessFile randomAccessFile) throws IOException {
        ...
        return h != null ? h : h(randomAccessFile, 65535);
    }
    ...
    public static X509Certificate[][] g(String str) throws f, SecurityException, IOException {
        ...
        try {
            ...
            if (a != null) {
                ...
                } else if (d(byteBuffer2) + b != longValue) {
                                            ...
                                            while (slice.hasRemaining()) {
                                                ...
                                                if (slice.remaining() >= i) {
                                                    ...
                                                    if (i4 > slice.remaining()) {
                                                        ...
                                                        X509Certificate[][] k = k(randomAccessFile.getChannel(), new e(r(slice, i4 - 4), longValue2, b, longValue, byteBuffer2));
        ...
        try {
            ...
            try {
                ...
                if (i <= 0) {
                    ...
                    m(hashMap, fileChannel, eVar.b, eVar.c, eVar.d, eVar.e);
    ...
    private static java.security.cert.X509Certificate[] l(java.nio.ByteBuffer r22, java.util.Map<java.lang.Integer, byte[]> r23, java.security.cert.CertificateFactory r24) throws java.lang.SecurityException, java.io.IOException {
        /*
            java.nio.ByteBuffer r0 = s(r22)
            java.nio.ByteBuffer r1 = s(r22)
            byte[] r2 = t(r22)
        ...
        L_0x0016:
            ...
            int r8 = r8 + 1
            java.nio.ByteBuffer r10 = s(r1)     // Catch:{ IOException -> 0x0066, BufferUnderflowException -> 0x0064 }
        ...
        L_0x0046:
            ...
            int r11 = o(r5)     // Catch:{ IOException -> 0x0066, BufferUnderflowException -> 0x0064 }
            int r12 = o(r7)     // Catch:{ IOException -> 0x0066, BufferUnderflowException -> 0x0064 }
            if (r11 == r15) goto L_0x0016
            if (r12 == r15) goto L_0x0055
            goto L_0x0016
        L_0x0055:
            byte[] r7 = t(r10)     // Catch:{ IOException -> 0x0066, BufferUnderflowException -> 0x0064 }
            r9 = r7
            r7 = r5
            goto L_0x0016
        L_0x005c:
        ...
        L_0x0164:
            ...
            int r5 = r5 + r15
            java.nio.ByteBuffer r8 = s(r1)     // Catch:{ IOException -> 0x0191, BufferUnderflowException -> 0x018f }
            ...
            byte[] r6 = t(r8)     // Catch:{ IOException -> 0x0191, BufferUnderflowException -> 0x018f }
            goto L_0x0164
        L_0x0187:
    ...
    private static byte[][] n(int[] iArr, c[] cVarArr) throws DigestException {
        ...
        if (j3 < TarConstants.MAXID) {
            ...
            while (true) {
                ...
                byte[] bArr2 = new byte[((q(iArr2[i4]) * i3) + 5)];
                bArr2[0] = 90;
                u(i3, bArr2);
                bArr[i4] = bArr2;
                i4++;
            ...
            for (i = 3; i6 < i; i = 3) {
                ...
                while (a > j2) {
                    ...
                    long j5 = j4;
                    try {
                        cVar.b(messageDigestArr, j5, min);
                        int i11 = 0;
