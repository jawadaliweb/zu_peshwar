...
public abstract class AbstractAppCenterService implements AppCenterService {
    ...
    public synchronized void setInstanceEnabled(boolean r13) {
        /*
            r12 = this;
            monitor-enter(r12)
            boolean r0 = r12.isInstanceEnabled()     // Catch:{ all -> 0x0081 }
            r1 = 1
            r2 = 0
            r3 = 2
            if (r13 != r0) goto L_0x002a
            java.lang.String r0 = r12.getLoggerTag()     // Catch:{ all -> 0x0081 }
            java.lang.String r4 = "%s service has already been %s."
            java.lang.Object[] r3 = new java.lang.Object[r3]     // Catch:{ all -> 0x0081 }
            java.lang.String r5 = r12.getServiceName()     // Catch:{ all -> 0x0081 }
            r3[r2] = r5     // Catch:{ all -> 0x0081 }
        ...
        L_0x001f:
            r3[r1] = r13     // Catch:{ all -> 0x0081 }
            java.lang.String r13 = java.lang.String.format(r4, r3)     // Catch:{ all -> 0x0081 }
            com.microsoft.appcenter.utils.AppCenterLog.info(r0, r13)     // Catch:{ all -> 0x0081 }
            monitor-exit(r12)
            return
        L_0x002a:
            java.lang.String r5 = r12.getGroupName()     // Catch:{ all -> 0x0081 }
            com.microsoft.appcenter.channel.Channel r4 = r12.mChannel     // Catch:{ all -> 0x0081 }
            if (r4 == 0) goto L_0x0053
            if (r5 == 0) goto L_0x0053
            if (r13 == 0) goto L_0x004b
            int r6 = r12.getTriggerCount()     // Catch:{ all -> 0x0081 }
            long r7 = r12.getTriggerInterval()     // Catch:{ all -> 0x0081 }
            int r9 = r12.getTriggerMaxParallelRequests()     // Catch:{ all -> 0x0081 }
            r10 = 0
            com.microsoft.appcenter.channel.Channel$GroupListener r11 = r12.getChannelListener()     // Catch:{ all -> 0x0081 }
            r4.addGroup(r5, r6, r7, r9, r10, r11)     // Catch:{ all -> 0x0081 }
            goto L_0x0053
        L_0x004b:
            r4.clear(r5)     // Catch:{ all -> 0x0081 }
            com.microsoft.appcenter.channel.Channel r0 = r12.mChannel     // Catch:{ all -> 0x0081 }
            r0.removeGroup(r5)     // Catch:{ all -> 0x0081 }
        L_0x0053:
            java.lang.String r0 = r12.getEnabledPreferenceKey()     // Catch:{ all -> 0x0081 }
            com.microsoft.appcenter.utils.storage.SharedPreferencesManager.putBoolean(r0, r13)     // Catch:{ all -> 0x0081 }
            java.lang.String r0 = r12.getLoggerTag()     // Catch:{ all -> 0x0081 }
        ...
        L_0x006f:
            r3[r1] = r2     // Catch:{ all -> 0x0081 }
            java.lang.String r1 = java.lang.String.format(r4, r3)     // Catch:{ all -> 0x0081 }
            com.microsoft.appcenter.utils.AppCenterLog.info(r0, r1)     // Catch:{ all -> 0x0081 }
            com.microsoft.appcenter.channel.Channel r0 = r12.mChannel     // Catch:{ all -> 0x0081 }
            if (r0 == 0) goto L_0x007f
            r12.applyEnabledState(r13)     // Catch:{ all -> 0x0081 }
        L_0x007f:
            monitor-exit(r12)
            return
        L_0x0081:
