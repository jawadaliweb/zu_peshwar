...
final class zzfh extends zzfk {
    ...
    public final void zze(int i, zzez zzez) throws IOException {
        zzq((i << 3) | 2);
        zzq(zzez.zzd());
        zzez.zzi(this);
    }
    ...
    public final void zzg(int i) throws IOException {
        try {
            ...
            throw new zzfi(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.zze), Integer.valueOf(this.zzd), 1}), e);
        }
    }
    ...
    public final void zzn(String str) throws IOException {
        ...
        try {
            ...
            if (zzy2 == zzy) {
                int i2 = i + zzy2;
                this.zze = i2;
                int zzb = zzju.zzb(str, this.zzc, i2, this.zzd - i2);
                this.zze = i;
                zzq((zzb - i) - zzy2);
                this.zze = zzb;
                return;
            ...
            byte[] bArr = this.zzc;
            int i3 = this.zze;
            this.zze = zzju.zzb(str, bArr, i3, this.zzd - i3);
        } catch (zzjt e) {
            this.zze = i;
            zzC(str, e);
    ...
    public final void zzc(byte[] bArr, int i, int i2) throws IOException {
        try {
            ...
            throw new zzfi(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.zze), Integer.valueOf(this.zzd), Integer.valueOf(i2)}), e);
        }
    }
    ...
    public final void zzs(long j) throws IOException {
        if (!zzfk.zzd || this.zzd - this.zze < 10) {
            ...
            while ((j & -128) != 0) {
                ...
                int i3 = this.zze;
                this.zze = i3 + 1;
                zzjp.zzn(bArr3, (long) i3, (byte) ((((int) j) & 127) | 128));
                j >>>= 7;
            }
            byte[] bArr4 = this.zzc;
            int i4 = this.zze;
            this.zze = i4 + 1;
            zzjp.zzn(bArr4, (long) i4, (byte) ((int) j));
        }
    }
}
