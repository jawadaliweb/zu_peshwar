...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        if (j3 == 0) {
            ...
            this.first = j;
            this.last = UProgressionUtilKt.m1268getProgressionLastElement7ftBX0g(j, j2, j3);
            this.step = j3;
        } else {
    ...
    public final long m1290getFirstsVKNKU() {
        return this.first;
    }

    /* renamed from: getLast-s-VKNKU  reason: not valid java name */
    public final long m1291getLastsVKNKU() {
        return this.last;
    }
    ...
    public int hashCode() {
        ...
        long j2 = this.last;
        long j3 = this.step;
        return ((int) (j3 ^ (j3 >>> 32))) + (((((int) ULong.m230constructorimpl(j ^ ULong.m230constructorimpl(j >>> 32))) * 31) + ((int) ULong.m230constructorimpl(j2 ^ ULong.m230constructorimpl(j2 >>> 32)))) * 31);
    }
    ...
    public String toString() {
        ...
        long j;
        if (this.step > 0) {
            sb.append(ULong.m275toStringimpl(this.first));
            sb.append("..");
            sb.append(ULong.m275toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1292fromClosedRange7ftBX0g(long j, long j2, long j3) {
