...
public final class zzhg {
    public static byte[] zza(byte[] bArr, byte[] bArr2) {
        ...
        while (true) {
            ...
            if (i2 < length) {
                ...
                long zzb7 = j2 + zzb(bArr5, 3, 2);
                long zzb8 = j + zzb(bArr5, 6, 4);
                long zzb9 = j3 + zzb(bArr5, 9, 6);
                long zzb10 = j4 + (zzb(bArr5, 12, 8) | ((long) (bArr5[16] << 24)));
                long j9 = zzb7 * zzb;
                long j10 = zzb7 * zzb2;
                long j11 = zzb7 * zzb3;
                long j12 = zzb9 * zzb;
                ...
                long zzc = (((j35 & j28) | (j29 & 67108863 & j36) | (j37 << 26)) & 4294967295L) + zzc(bArr3, 16);
                long zzc2 = (((j37 >> 6) | (j38 << 20)) & 4294967295L) + zzc(bArr3, 20);
                long zzc3 = (((j38 >> 12) | (j39 << 14)) & 4294967295L) + zzc(bArr3, 24);
                long zzc4 = (((j39 >> 18) | (j40 << 8)) & 4294967295L) + zzc(bArr3, 28);
                byte[] bArr6 = new byte[16];
                zzd(bArr6, zzc & 4294967295L, 0);
                long j41 = zzc2 + (zzc >> 32);
                zzd(bArr6, j41 & 4294967295L, 4);
                long j42 = zzc3 + (j41 >> 32);
                zzd(bArr6, j42 & 4294967295L, 8);
                zzd(bArr6, (zzc4 + (j42 >> 32)) & 4294967295L, 12);
                return bArr6;
            }
        }
    }
    ...
    private static long zzc(byte[] bArr, int i) {
        ...
        return ((long) (((bArr[i + 3] & UByte.MAX_VALUE) << 24) | (b2 << 8) | b | (b3 << 16))) & 4294967295L;
    }
