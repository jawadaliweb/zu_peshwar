...
public class AppCenter {
    ...
    private synchronized boolean configureInstance(android.app.Application r4, java.lang.String r5, final boolean r6) {
        /*
            ...
            com.microsoft.appcenter.utils.AppCenterLog.error(r4, r5)     // Catch:{ all -> 0x0097 }
            monitor-exit(r3)
            return r0
        L_0x000d:
            boolean r1 = r3.mLogLevelConfigured     // Catch:{ all -> 0x0097 }
            if (r1 != 0) goto L_0x001f
            android.content.pm.ApplicationInfo r1 = r4.getApplicationInfo()     // Catch:{ all -> 0x0097 }
            int r1 = r1.flags     // Catch:{ all -> 0x0097 }
            r2 = 2
            r1 = r1 & r2
            if (r1 != r2) goto L_0x001f
            r1 = 5
            com.microsoft.appcenter.utils.AppCenterLog.setLogLevel(r1)     // Catch:{ all -> 0x0097 }
        L_0x001f:
            java.lang.String r1 = r3.mAppSecret     // Catch:{ all -> 0x0097 }
            if (r6 == 0) goto L_0x002b
            boolean r5 = r3.configureSecretString(r5)     // Catch:{ all -> 0x0097 }
            if (r5 != 0) goto L_0x002b
            monitor-exit(r3)
            return r0
        L_0x002b:
            android.os.Handler r5 = r3.mHandler     // Catch:{ all -> 0x0097 }
            r0 = 1
            if (r5 == 0) goto L_0x0046
            java.lang.String r4 = r3.mAppSecret     // Catch:{ all -> 0x0097 }
            if (r4 == 0) goto L_0x0044
            boolean r4 = r4.equals(r1)     // Catch:{ all -> 0x0097 }
            if (r4 != 0) goto L_0x0044
            android.os.Handler r4 = r3.mHandler     // Catch:{ all -> 0x0097 }
            com.microsoft.appcenter.AppCenter$4 r5 = new com.microsoft.appcenter.AppCenter$4     // Catch:{ all -> 0x0097 }
            r5.<init>()     // Catch:{ all -> 0x0097 }
            r4.post(r5)     // Catch:{ all -> 0x0097 }
        L_0x0044:
            monitor-exit(r3)
            return r0
        L_0x0046:
            r3.mApplication = r4     // Catch:{ all -> 0x0097 }
            android.os.HandlerThread r4 = new android.os.HandlerThread     // Catch:{ all -> 0x0097 }
            java.lang.String r5 = "AppCenter.Looper"
            r4.<init>(r5)     // Catch:{ all -> 0x0097 }
            r3.mHandlerThread = r4     // Catch:{ all -> 0x0097 }
            r4.start()     // Catch:{ all -> 0x0097 }
            android.os.Handler r4 = new android.os.Handler     // Catch:{ all -> 0x0097 }
            android.os.HandlerThread r5 = r3.mHandlerThread     // Catch:{ all -> 0x0097 }
            android.os.Looper r5 = r5.getLooper()     // Catch:{ all -> 0x0097 }
            r4.<init>(r5)     // Catch:{ all -> 0x0097 }
            r3.mHandler = r4     // Catch:{ all -> 0x0097 }
            com.microsoft.appcenter.AppCenter$5 r4 = new com.microsoft.appcenter.AppCenter$5     // Catch:{ all -> 0x0097 }
            r4.<init>()     // Catch:{ all -> 0x0097 }
            r3.mAppCenterHandler = r4     // Catch:{ all -> 0x0097 }
            com.microsoft.appcenter.utils.ApplicationLifecycleListener r4 = new com.microsoft.appcenter.utils.ApplicationLifecycleListener     // Catch:{ all -> 0x0097 }
            android.os.Handler r5 = r3.mHandler     // Catch:{ all -> 0x0097 }
            r4.<init>(r5)     // Catch:{ all -> 0x0097 }
            r3.mApplicationLifecycleListener = r4     // Catch:{ all -> 0x0097 }
            android.app.Application r5 = r3.mApplication     // Catch:{ all -> 0x0097 }
            r5.registerActivityLifecycleCallbacks(r4)     // Catch:{ all -> 0x0097 }
            java.util.HashSet r4 = new java.util.HashSet     // Catch:{ all -> 0x0097 }
            r4.<init>()     // Catch:{ all -> 0x0097 }
            r3.mServices = r4     // Catch:{ all -> 0x0097 }
            java.util.HashSet r4 = new java.util.HashSet     // Catch:{ all -> 0x0097 }
            r4.<init>()     // Catch:{ all -> 0x0097 }
            r3.mServicesStartedFromLibrary = r4     // Catch:{ all -> 0x0097 }
            android.os.Handler r4 = r3.mHandler     // Catch:{ all -> 0x0097 }
            com.microsoft.appcenter.AppCenter$6 r5 = new com.microsoft.appcenter.AppCenter$6     // Catch:{ all -> 0x0097 }
            r5.<init>(r6)     // Catch:{ all -> 0x0097 }
            r4.post(r5)     // Catch:{ all -> 0x0097 }
            java.lang.String r4 = "AppCenter"
            java.lang.String r5 = "App Center SDK configured successfully."
            com.microsoft.appcenter.utils.AppCenterLog.info(r4, r5)     // Catch:{ all -> 0x0097 }
            monitor-exit(r3)
            return r0
        L_0x0097:
            r4 = move-exception
    ...
    public void finishStartServices(Iterable<AppCenterService> iterable, Iterable<AppCenterService> iterable2, boolean z) {
        ...
        for (AppCenterService next2 : iterable2) {
            ...
            if (z) {
                next2.onStarted(this.mApplication, this.mChannel, this.mAppSecret, this.mTransmissionTargetToken, true);
                AppCenterLog.info("AppCenter", next2.getClass().getSimpleName() + " service started from application.");
            } else {
                next2.onStarted(this.mApplication, this.mChannel, (String) null, (String) null, false);
