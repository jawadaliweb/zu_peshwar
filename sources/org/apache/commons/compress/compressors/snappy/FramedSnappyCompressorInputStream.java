...
public class FramedSnappyCompressorInputStream extends CompressorInputStream implements InputStreamStatistics {
    ...
    private final PushbackInputStream f29in;
    ...
    public FramedSnappyCompressorInputStream(InputStream inputStream, int i, FramedSnappyDialect framedSnappyDialect) throws IOException {
        ...
        if (i > 0) {
            ...
            this.f29in = new PushbackInputStream(countingInputStream, 1);
            this.blockSize = i;
    ...
    public int available() throws IOException {
        if (this.inUncompressedChunk) {
            return Math.min(this.uncompressedBytesRemaining, this.f29in.available());
        }
        SnappyCompressorInputStream snappyCompressorInputStream = this.currentCompressedChunk;
        if (snappyCompressorInputStream != null) {
    ...
    private int readOnce(byte[] r5, int r6, int r7) throws java.io.IOException {
        /*
            ...
            return r1
        L_0x000e:
            java.io.PushbackInputStream r0 = r4.f29in
    ...
    private void readNextBlock() throws IOException {
        ...
        if (readOneByte == -1) {
            ...
            if (readSize2 >= 0) {
                ...
                SnappyCompressorInputStream snappyCompressorInputStream = new SnappyCompressorInputStream(new BoundedInputStream(this.f29in, readSize2), this.blockSize);
    ...
    private long readCrc() throws IOException {
        ...
        int readFully = IOUtils.readFully((InputStream) this.f29in, bArr);
        count(readFully);
        if (readFully == 4) {
    ...
    private void skipBlock() throws IOException {
        ...
        if (readSize >= 0) {
            ...
            long skip = IOUtils.skip(this.f29in, j);
            count(skip);
            if (skip != j) {
                throw new IOException("Premature end of stream");
            }
