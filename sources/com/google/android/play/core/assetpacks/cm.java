...
final class cm {
    ...
    public final int a(byte[] bArr, int i2, int i3) {
        ...
        if (this.c == -1) {
            ...
            if (d2 == 67324752) {
                ...
                int e3 = this.e + 30 + ck.e(this.a, 28);
                this.f = e3;
    ...
    public final de b() {
        ...
        int i3 = this.f;
        if (i2 < i3) {
            return de.a(this.i, this.d, this.g, true, Arrays.copyOf(this.a, i2), this.h);
        }
        de a2 = de.a(this.i, this.d, this.g, false, Arrays.copyOf(this.a, i3), this.h);
        d();
        return a2;
    }
