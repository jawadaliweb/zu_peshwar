...
public final class ck {
    ...
    static AssetLocation b(String str, String str2) throws IOException {
        ...
        String str3 = str;
        String str4 = str2;
        ax.c(str3 != null, "Attempted to get file location from a null apk path.");
        ax.c(str4 != null, String.format("Attempted to get file location in apk %s with a null file path.", new Object[]{str3}));
        RandomAccessFile randomAccessFile = new RandomAccessFile(str3, "r");
        byte[] bArr = new byte[22];
        randomAccessFile.seek(randomAccessFile.length() - 22);
        randomAccessFile.readFully(bArr);
        bb k = c(bArr, 0) == 1347093766 ? k(bArr) : null;
        byte b = 5;
        if (k == null) {
        ...
        while (true) {
            ...
            if (c == 1347092738) {
                ...
                throw new ZipException(String.format("Missing central directory file header signature when looking for file %s in APK %s. Read %d entries out of %d. Found %d instead of the header signature %d.", new Object[]{str4, str3, Integer.valueOf(i3), Integer.valueOf(k.b), Integer.valueOf(c), 1347092738}));
            }
        }
        if (l == null) {
            return null;
        ...
        return AssetLocation.a(str3, longValue + 30 + ((long) e(bArr6, 4)) + ((long) e(bArr6, 6)), d(bArr6, 0));
    }
