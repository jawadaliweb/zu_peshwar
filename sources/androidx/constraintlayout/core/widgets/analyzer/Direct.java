                    ...
                    if (constraintWidget3.getHorizontalDimensionBehaviour() != ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT || canMeasure) {
                        if (!constraintWidget3.isMeasureRequested()) {
                            if (next == constraintWidget3.mLeft && constraintWidget3.mRight.mTarget == null) {
                                ...
                                horizontalSolvingPass(i3, constraintWidget3, measurer2, z2);
                            } else if (next == constraintWidget3.mLeft && constraintWidget3.mRight.mTarget != null && constraintWidget3.mRight.mTarget.hasFinalValue() && !constraintWidget3.isInHorizontalChain()) {
                        ...
                        if ((constraintWidget3.getVisibility() == 8 || (constraintWidget3.mMatchConstraintDefaultWidth == 0 && constraintWidget3.getDimensionRatio() == 0.0f)) && !constraintWidget3.isInHorizontalChain() && !constraintWidget3.isInVirtualLayout()) {
                            if (((next == constraintWidget3.mLeft && constraintWidget3.mRight.mTarget != null && constraintWidget3.mRight.mTarget.hasFinalValue()) || (next == constraintWidget3.mRight && constraintWidget3.mLeft.mTarget != null && constraintWidget3.mLeft.mTarget.hasFinalValue())) && !constraintWidget3.isInHorizontalChain()) {
            ...
            if (!(constraintWidget2 instanceof Guideline)) {
                if (anchor2.getDependents() != null && anchor2.hasFinalValue()) {
                    ...
                    while (it2.hasNext()) {
                        ...
                        boolean z3 = (next2 == constraintWidget4.mLeft && constraintWidget4.mRight.mTarget != null && constraintWidget4.mRight.mTarget.hasFinalValue()) || (next2 == constraintWidget4.mRight && constraintWidget4.mLeft.mTarget != null && constraintWidget4.mLeft.mTarget.hasFinalValue());
                        if (constraintWidget4.getHorizontalDimensionBehaviour() != ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT || canMeasure2) {
                            if (!constraintWidget4.isMeasureRequested()) {
                                if (next2 == constraintWidget4.mLeft && constraintWidget4.mRight.mTarget == null) {
                                    ...
                                    horizontalSolvingPass(i4, constraintWidget4, measurer2, z2);
                                } else if (z3 && !constraintWidget4.isInHorizontalChain()) {
                            ...
                            if ((constraintWidget4.getVisibility() == 8 || (constraintWidget4.mMatchConstraintDefaultWidth == 0 && constraintWidget4.getDimensionRatio() == 0.0f)) && !constraintWidget4.isInHorizontalChain() && !constraintWidget4.isInVirtualLayout() && z3 && !constraintWidget4.isInHorizontalChain()) {
                ...
                while (it.hasNext()) {
                    ...
                    if (constraintWidget3.getVerticalDimensionBehaviour() != ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT || canMeasure) {
                        if (!constraintWidget3.isMeasureRequested()) {
                            if (next == constraintWidget3.mTop && constraintWidget3.mBottom.mTarget == null) {
                            ...
                            } else if (next == constraintWidget3.mBottom && constraintWidget3.mBottom.mTarget == null) {
                                ...
                                verticalSolvingPass(i3, constraintWidget3, measurer2);
                            } else if (next == constraintWidget3.mTop && constraintWidget3.mBottom.mTarget != null && constraintWidget3.mBottom.mTarget.hasFinalValue()) {
                        ...
                        if ((constraintWidget3.getVisibility() == 8 || (constraintWidget3.mMatchConstraintDefaultHeight == 0 && constraintWidget3.getDimensionRatio() == 0.0f)) && !constraintWidget3.isInVerticalChain() && !constraintWidget3.isInVirtualLayout()) {
                            if (((next == constraintWidget3.mTop && constraintWidget3.mBottom.mTarget != null && constraintWidget3.mBottom.mTarget.hasFinalValue()) || (next == constraintWidget3.mBottom && constraintWidget3.mTop.mTarget != null && constraintWidget3.mTop.mTarget.hasFinalValue())) && !constraintWidget3.isInVerticalChain()) {
            ...
            if (!(constraintWidget2 instanceof Guideline)) {
                if (anchor2.getDependents() != null && anchor2.hasFinalValue()) {
                    ...
                    while (it2.hasNext()) {
                        ...
                        boolean z = (next2 == constraintWidget4.mTop && constraintWidget4.mBottom.mTarget != null && constraintWidget4.mBottom.mTarget.hasFinalValue()) || (next2 == constraintWidget4.mBottom && constraintWidget4.mTop.mTarget != null && constraintWidget4.mTop.mTarget.hasFinalValue());
