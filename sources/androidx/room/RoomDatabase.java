...
public abstract class RoomDatabase {
                ...
                if (it.hasNext()) {
                    ...
                    while (true) {
                        if (size < 0) {
                            size = -1;
                            break;
                        } else if (cls2.isAssignableFrom(databaseConfiguration.typeConverters.get(size).getClass())) {
                            bitSet.set(size);
                            break;
                        } else {
                            size--;
                    ...
                    if (size >= 0) {
                        this.mTypeConverters.put(cls2, databaseConfiguration.typeConverters.get(size));
                    } else {
        ...
        if (autoCloser == null) {
            ...
            autoCloser.executeRefCountingFunction(new Function() {
                public final Object apply(Object obj) {
                    return RoomDatabase.this.lambda$beginTransaction$0$RoomDatabase((SupportSQLiteDatabase) obj);
                }
            });
        }
    }
    ...
    public void endTransaction() {
        ...
        if (autoCloser == null) {
            ...
            autoCloser.executeRefCountingFunction(new Function() {
                public final Object apply(Object obj) {
                    return RoomDatabase.this.lambda$endTransaction$1$RoomDatabase((SupportSQLiteDatabase) obj);
                }
            });
        }
    }
