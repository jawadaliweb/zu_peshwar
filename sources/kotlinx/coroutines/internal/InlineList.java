...
public final class InlineList<E> {
    ...
    public static final /* synthetic */ InlineList m1591boximpl(Object obj) {
        return new InlineList(obj);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static <E> Object m1592constructorimpl(Object obj) {
        return obj;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1594equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof InlineList) && Intrinsics.areEqual(obj, ((InlineList) obj2).m1600unboximpl());
    }
    ...
    public boolean equals(Object obj) {
        return m1594equalsimpl(this.holder, obj);
    }

    public int hashCode() {
        return m1597hashCodeimpl(this.holder);
    }

    public String toString() {
        return m1599toStringimpl(this.holder);
    }
    ...
    public static /* synthetic */ Object m1593constructorimpl$default(Object obj, int i, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i & 1) != 0) {
            obj = null;
        }
        return m1592constructorimpl(obj);
    }

    /* renamed from: plus-FjFbRPM  reason: not valid java name */
    public static final Object m1598plusFjFbRPM(Object obj, E e) {
        if (DebugKt.getASSERTIONS_ENABLED() && !(!(e instanceof List))) {
            throw new AssertionError();
        } else if (obj == null) {
            return m1592constructorimpl(e);
        } else {
            ...
            arrayList.add(obj);
            arrayList.add(e);
            return m1592constructorimpl(arrayList);
        }
    }

    /* renamed from: forEachReversed-impl  reason: not valid java name */
    public static final void m1596forEachReversedimpl(Object obj, Function1<? super E, Unit> function1) {
        if (obj != null) {
            if (!(obj instanceof ArrayList)) {
