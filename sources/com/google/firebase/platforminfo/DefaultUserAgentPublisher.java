...
public class DefaultUserAgentPublisher implements UserAgentPublisher {
    ...
    public static Component<UserAgentPublisher> component() {
        return Component.builder(UserAgentPublisher.class).add(Dependency.setOf((Class<?>) LibraryVersion.class)).factory($$Lambda$DefaultUserAgentPublisher$4ig3kBSwJpLAUmRXJRn9olP8BdE.INSTANCE).build();
    }
